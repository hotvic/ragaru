...
#define DECLARE_COMMAND(cmd) static void ch_##cmd(Ragaru::Game* game, const char* args);
#include "ConsoleCmds.h"
#undef DECLARE_COMMAND
...
static void ch_quit(Ragaru::Game* game, const char* args)
{
    game->tryquit = 1;
}

static void ch_map(Ragaru::Game* game, const char* args)
{
    char buf[64];
...
static void ch_save(Ragaru::Game* game, const char* args)
{
    /*char buf[64];
    ...
    fpackf(tfile, "Bf Bf Bf Bf Bf Bi", player[0].coords.x, player[0].coords.y, player[0].coords.z, player[0].rotation,
  player[0].targetrotation, player[0].numweapons);

    if (player[0].numweapons > 0 && player[0].numweapons < 5)
        for (int j = 0; j < player[0].numweapons; j++)
        {
  ...
  fpackf(tfile, "Bi", numdialogues);
    if(numdialogues)
        for (int k = 0; k < numdialogues; k++)
        {
            ...
            for(int l = 0; l < 10; l++)
            {
                    fpackf(tfile, "Bf Bf Bf", participantlocation[k][l].x, participantlocation[k][l].y,
  participantlocation[k][l].z);
            ...
            if (numdialogueboxes)
                    for(int l = 0; l < numdialogueboxes[k]; l++)
                {
                        ...
                        for(int m = 0; m < templength; m++)
                    {
                        ...
                        fpackf(tfile, "Bf Bf Bf", dialoguecamera[k][l].x, dialoguecamera[k][l].y,
  dialoguecamera[k][l].z);
                        fpackf(tfile, "Bi", participantfocus[k][l]);
                        fpackf(tfile, "Bi", participantaction[k][l]);

                        for(int m = 0; m < 10; m++)
                            fpackf(tfile, "Bf Bf Bf", participantfacing[k][l][m].x, participantfacing[k][l][m].y,
  participantfacing[k][l][m].z);
  ...
  if(numplayers>1&&numplayers<maxplayers)
    for(j=1;j<numplayers;j++){
      fpackf(tfile, "Bi Bi Bf Bf Bf Bi Bi Bf Bb Bf", player[j].whichskin, player[j].creature, player[j].coords.x,
  player[j].coords.y, player[j].coords.z, player[j].numweapons, player[j].howactive, player[j].scale,
  player[j].immobile, player[j].rotation);
      if (player[j].numweapons > 0 && player[j].numweapons < 5)
        for (int k = 0; k < player[j].numweapons; k++)
    {
  ...
  if(game->numpathpoints)
    for(j=0;j<game->numpathpoints;j++){
      fpackf(tfile, "Bf Bf Bf Bi", game->pathpoint[j].x, game->pathpoint[j].y, game->pathpoint[j].z,
  game->numpathpointconnect[j]);
...
static void ch_cellar(Ragaru::Game* game, const char* args)
{
    game->LoadTextureSave("furdarko.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
}

static void ch_tint(Ragaru::Game* game, const char* args)
{
    sscanf(args, "%f%f%f", &tintr, &tintg, &tintb);
}

static void ch_tintr(Ragaru::Game* game, const char* args)
{
    tintr = atof(args);
}

static void ch_tintg(Ragaru::Game* game, const char* args)
{
    tintg = atof(args);
}

static void ch_tintb(Ragaru::Game* game, const char* args)
{
    tintb = atof(args);
}

static void ch_speed(Ragaru::Game* game, const char* args)
{
    player[0].speedmult = atof(args);
}

static void ch_strength(Ragaru::Game* game, const char* args)
{
    player[0].power = atof(args);
}

static void ch_power(Ragaru::Game* game, const char* args)
{
    player[0].power = atof(args);
}

static void ch_size(Ragaru::Game* game, const char* args)
{
...
static void ch_sizenear(Ragaru::Game* game, const char* args)
{
...
static void ch_proportion(Ragaru::Game* game, const char* args)
{
    set_proportion(0, args);
}

static void ch_proportionnear(Ragaru::Game* game, const char* args)
{
    int closest = find_closest();
    if(closest)
...
static void ch_protection(Ragaru::Game* game, const char* args)
{
    set_protection(0, args);
}

static void ch_protectionnear(Ragaru::Game* game, const char* args)
{
    int closest = find_closest();
    if(closest)
...
static void ch_armor(Ragaru::Game* game, const char* args)
{
    set_armor(0, args);
}

static void ch_armornear(Ragaru::Game* game, const char* args)
{
    int closest = find_closest();
    if(closest)
...
static void ch_protectionreset(Ragaru::Game* game, const char* args)
{
...
static void ch_metal(Ragaru::Game* game, const char* args)
{
    set_metal(0, args);
}

static void set_noclothes(int pnum, Ragaru::Game* game, const char* args)
{
    player[pnum].numclothes = 0;
    game->LoadTextureSave(creatureskin[player[pnum].creature][player[pnum].whichskin],
                          &player[pnum].skeleton.drawmodel.textureptr,
                          1,
                          &player[pnum].skeleton.skinText[0],
                          &player[pnum].skeleton.skinsize);
}

static void ch_noclothes(Ragaru::Game* game, const char* args)
{
    set_noclothes(0, game, args);
}

static void ch_noclothesnear(Ragaru::Game* game, const char* args)
{
    int closest = find_closest();
    if(closest)
...
static void set_clothes(int pnum, Ragaru::Game* game, const char* args)
{
    char buf[64];
    snprintf(buf, 63, "%s.png", args);
...
static void ch_clothes(Ragaru::Game* game, const char* args)
{
    set_clothes(0, game, args);
}

static void ch_clothesnear(Ragaru::Game* game, const char* args)
{
    int closest = find_closest();
    if(closest)
...
static void ch_belt(Ragaru::Game* game, const char* args)
{
    player[0].skeleton.clothes = !player[0].skeleton.clothes;
}

static void ch_cellophane(Ragaru::Game* game, const char* args)
{
...
static void ch_funnybunny(Ragaru::Game* game, const char* args)
{
    player[0].skeleton.id = 0;
    player[0].skeleton.Load("Skeleton/Basic Figure",
...
static void ch_wolfie(Ragaru::Game* game, const char* args)
{
    player[0].skeleton.id = 0;
    player[0].skeleton.Load("Skeleton/Basic Figure Wolf",
...
static void ch_wolf(Ragaru::Game* game, const char* args)
{
    game->LoadTextureSave("wolf.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
...
static void ch_snowwolf(Ragaru::Game* game, const char* args)
{
    game->LoadTextureSave("snowwolf.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
static void ch_darkwolf(Ragaru::Game* game, const char* args)
{
    game->LoadTextureSave("darkwolf.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
static void ch_white(Ragaru::Game* game, const char* args)
{
    game->LoadTextureSave("fur.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
static void ch_brown(Ragaru::Game* game, const char* args)
{
    game->LoadTextureSave("fur3.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
...
static void ch_black(Ragaru::Game* game, const char* args)
{
    game->LoadTextureSave("fur2.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
static void ch_sizemin(Ragaru::Game* game, const char* args)
{
    int i;
...
static void ch_tutorial(Ragaru::Game* game, const char* args)
{
    tutoriallevel = atoi(args);
}

static void ch_hostile(Ragaru::Game* game, const char* args)
{
    hostile = atoi(args);
}

static void ch_indemo(Ragaru::Game* game, const char* args)
{
    game->indemo = 1;
...
static void ch_notindemo(Ragaru::Game* game, const char* args)
{
    game->indemo = 0;
    numhotspots--;
}

static void ch_type(Ragaru::Game* game, const char* args)
{
...
static void ch_path(Ragaru::Game* game, const char* args)
{
...
static void ch_hs(Ragaru::Game* game, const char* args)
{
    hotspot[numhotspots] = player[0].coords;
...
static void ch_dialogue(Ragaru::Game* game, const char* args)
{
    int dlg, i, j;
    char buf1[32], buf2[64];

    sscanf(args, "%d %31s", &dlg, buf1);
    snprintf(buf2, 63, "%s.txt", buf1);
    ...
    ifstream ipstream(locateDataFile("dialogues", buf2).c_str());
    ipstream.ignore(256, ':');
...
static void ch_fixdialogue(Ragaru::Game* game, const char* args)
{
    char buf1[32], buf2[64];
    int whichdi, i, j;
...
static void ch_fixtype(Ragaru::Game* game, const char* args)
{
    int dlg;
    sscanf(args, "%d", &dlg);
    dialoguetype[0] = dlg;
...
static void ch_fixrotation(Ragaru::Game* game, const char* args)
{
    participantrotation[whichdialogue][participantfocus[whichdialogue][indialogue]] =
        player[participantfocus[whichdialogue][indialogue]].rotation;
}

static void ch_ddialogue(Ragaru::Game* game, const char* args)
{
    if(numdialogues)
        numdialogues--;
}

static void ch_dhs(Ragaru::Game* game, const char* args)
{
    if(numhotspots)
        numhotspots--;
}

static void ch_immobile(Ragaru::Game* game, const char* args)
{
    player[0].immobile = 1;
}

static void ch_allimmobile(Ragaru::Game* game, const char* args)
{
    for(int i = 1; i < numplayers; i++)
        player[i].immobile = 1;
}

static void ch_mobile(Ragaru::Game* game, const char* args)
{
    player[0].immobile = 0;
}

static void ch_default(Ragaru::Game* game, const char* args)
{
...
static void ch_play(Ragaru::Game* game, const char* args)
{
    int dlg, i;
    sscanf(args, "%d", &dlg);
    whichdialogue = dlg;
    ...
    for(i = 0; i < numdialogueboxes[whichdialogue]; i++) {
        player[participantfocus[whichdialogue][i]].coords =
            participantlocation[whichdialogue][participantfocus[whichdialogue][i]];
        player[participantfocus[whichdialogue][i]].rotation =
            participantrotation[whichdialogue][participantfocus[whichdialogue][i]];
        player[participantfocus[whichdialogue][i]].targetrotation =
            participantrotation[whichdialogue][participantfocus[whichdialogue][i]];
        player[participantfocus[whichdialogue][i]].velocity = 0;
        player[participantfocus[whichdialogue][i]].targetanimation =
            player[participantfocus[whichdialogue][i]].getIdle();
...
static void ch_mapkilleveryone(Ragaru::Game* game, const char* args)
{
    maptype = mapkilleveryone;
}

static void ch_mapkillmost(Ragaru::Game* game, const char* args)
{
    maptype = mapkillmost;
}

static void ch_mapkillsomeone(Ragaru::Game* game, const char* args)
{
    maptype = mapkillsomeone;
}

static void ch_mapgosomewhere(Ragaru::Game* game, const char* args)
{
    maptype = mapgosomewhere;
}

static void ch_viewdistance(Ragaru::Game* game, const char* args)
{
    viewdistance = atof(args) * 100;
}

static void ch_fadestart(Ragaru::Game* game, const char* args)
{
    fadestart = atof(args);
}

static void ch_slomo(Ragaru::Game* game, const char* args)
{
...
static void ch_slofreq(Ragaru::Game* game, const char* args)
{
    slomofreq = atof(args);
}

static void ch_skytint(Ragaru::Game* game, const char* args)
{
...
static void ch_skylight(Ragaru::Game* game, const char* args)
{
...
static void ch_skybox(Ragaru::Game* game, const char* args)
{
...
static void cmd_dispatch(Ragaru::Game* game, const char* cmd)
{
        ...
        */
        ...
        if(!mainmenu) {
            ...
            if(!freeze && !winfreeze && !(mainmenu && gameon) && (gameon || !gamestarted)) {
                ...
                temppoint+=sizeof(int);
                memcpy(chatname+temppoint,&player[i].numweapons,sizeof(int));
                temppoint+=sizeof(int);
                ...
                sprintf (chatname, "%d %f %f %f %f %f %d %d %f %f %f %d %d %f %f
                %f",i,player[i].coords.x,player[i].coords.y,player[i].coords.z,player[i].damage,player[i].target,
                player[i].targetanimation, player[i].currentanimation, player[i].velocity.x, player[i].velocity.y,
                player[i].velocity.z, player[i].targetframe, player[i].currentframe, player[i].rotation,
                ...
                sprintf (chatname, "%d %f %d %d %d %d %d %d %d %d %f",i,player[i].bloodloss, player[i].weaponactive,
                player[i].numweapons, player[i].weaponids[0], player[i].weaponids[1], player[i].weaponids[2],
                player[i].weaponids[3],player[i].dead,player[i].skeleton.free,player[i].permanentdamage);
