...
static const char* rabbitskin[] = { "textures/fur3.jpg",  "textures/fur.jpg",       "textures/fur2.jpg",
                                    "textures/lynx.jpg",  "textures/otter.jpg",     "textures/opal.jpg",
                                    "textures/sable.jpg", "textures/chocolate.jpg", "textures/bw2.jpg",
                                    "textures/wb2.jpg" };

static const char* wolfskin[] = { "textures/wolf.jpg", "textures/darkwolf.jpg", "textures/snowwolf.jpg" };
...
{
    game->LoadTextureSave("textures/furdarko.jpg",
...
static void ch_funnybunny(Game* game, const char* args)
{
    ...
    player[0].skeleton.Load("Skeleton/Basic Figure",
                            ...
                            "Models/Belt.solid",
                            1);
    game->LoadTextureSave("textures/fur3.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
static void ch_wolfie(Game* game, const char* args)
{
    ...
    player[0].skeleton.Load("Skeleton/Basic Figure Wolf",
                            ...
                            "Models/welt.solid",
                            0);
    game->LoadTextureSave("textures/wolf.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
{
    game->LoadTextureSave("textures/snowwolf.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
{
    game->LoadTextureSave("textures/darkwolf.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
{
    game->LoadTextureSave("textures/fur.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
{
    game->LoadTextureSave("textures/fur2.jpg",
                          &player[0].skeleton.drawmodel.textureptr,
                          1,
                          &player[0].skeleton.skinText[0],
                          &player[0].skeleton.skinsize);
...
void Screenshot(void)
{
    ...
    MAC_error_code = ::QTNewGWorldFromPtr (&MAC_offscreen_graphics_port, k32ARGBPixelFormat, &MAC_picture_rectangle,
    NULL, NULL, 0, (char *) MAC_pixels, screenwidth * 4);
    if (MAC_error_code)	{
...
void Game::Setenvironment(int which)
{
    ...
    */
    ...
    if(environment == snowyenvironment) {
        ...
        if(texdetail > 1)
            texdetail = 4;
        skybox.load("textures/skyboxsnowfront.jpg",
    ...
    if(environment == desertenvironment) {
        ...
        if(texdetail > 1)
            texdetail = 4;
        skybox.load("textures/skyboxsandfront.jpg",
    ...
    if(environment == grassyenvironment) {
        ...
        if(texdetail > 1)
            texdetail = 4;
        skybox.load("textures/skyboxgrassfront.jpg",
...
void Game::Loadlevel(int which)
{
    ...
    case -1:
        ...
        break;
    case 0:
        Loadlevel((char*)"maps/map1");
        break;
    case 1:
        Loadlevel((char*)"maps/map2");
        break;
    case 2:
        Loadlevel((char*)"maps/map3");
        break;
    case 3:
        Loadlevel((char*)"maps/map4");
        break;
    case 4:
        Loadlevel((char*)"maps/map5");
        break;
    case 5:
        Loadlevel((char*)"maps/map6");
        break;
    case 6:
        Loadlevel((char*)"maps/map7");
        break;
    case 7:
        Loadlevel((char*)"maps/map8");
        break;
    case 8:
        Loadlevel((char*)"maps/map9");
        break;
    case 9:
        Loadlevel((char*)"maps/map10");
        break;
    case 10:
        Loadlevel((char*)"maps/map11");
        break;
    case 11:
        Loadlevel((char*)"maps/map12");
        break;
    case 12:
        Loadlevel((char*)"maps/map13");
        break;
    case 13:
        Loadlevel((char*)"maps/map14");
        break;
    case 14:
        Loadlevel((char*)"maps/map15");
        break;
    case 15:
        Loadlevel((char*)"maps/map16");
        break;
    default:
        Loadlevel((char*)"maps/mapsave");
        break;
    }
...
void Game::Loadlevel(char* name)
{
    ...
    if(tfile) {
        ...
        if(accountactive != -1)
            difficulty = accountdifficulty[accountactive];
        ...
        for(int i = 0; i < numplayers; i++) {
            ...
            if(player[i].creature != wolftype)
                player[i].skeleton.Load((char*)"Skeleton/Basic Figure",
                ...
                if(player[i].creature == wolftype) {
                    player[i].skeleton.Load((char*)"Skeleton/Basic Figure Wolf",
                ...
                if(closest != -1) {
                    ...
                    if(player[closest].creature == rabbittype) {
                        ...
                        player[closest].skeleton.Load((char*)"Skeleton/Basic Figure Wolf",
                                                      ...
                                                      (char*)"Models/belt.solid",
                                                      0);
                        LoadTextureSave("textures/wolf.jpg",
                                        &player[closest].skeleton.drawmodel.textureptr,
                                        1,
                        ...
                        player[closest].skeleton.Load((char*)"Skeleton/Basic Figure",
                                                      ...
                                                      (char*)"Models/Belt.solid",
                                                      1);
                        LoadTextureSave("textures/fur3.jpg",
                                        &player[closest].skeleton.drawmodel.textureptr,
                                        1,
                                        &player[closest].skeleton.skinText[0],
                                        &player[closest].skeleton.skinsize);
            ...
            if(IsKeyDown(SDL_SCANCODE_P, ~KMOD_SHIFT | ~KMOD_CTRL) && !drawmodetogglekeydown && editorenabled) {
                if(numplayers < maxplayers - 1) {
                    ...
                    if(k == 0) {
                        ...
                        LoadTextureSave("textures/fur.jpg",
                                        &player[numplayers].skeleton.drawmodel.textureptr,
                                        1,
                                        &player[numplayers].skeleton.skinText[0],
                                        &player[numplayers].skeleton.skinsize);
                        ...
                        LoadTextureSave("textures/fur2.jpg",
                                        &player[numplayers].skeleton.drawmodel.textureptr,
                                        1,
                                        &player[numplayers].skeleton.skinText[0],
                                        &player[numplayers].skeleton.skinsize);
            ...
            for(int i = 0; i < numplayers; i++) {
                if(!player[i].skeleton.free) {
                            ...
                            if(player[i].damage < player[i].damagetolerance / 2)
                                if(animation[player[i].targetanimation].height != highheight)
                                    if(player[i].damage < player[i].damagetolerance * .5 &&
                                       ((player[0].targetanimation == walljumprightkickanim ||
                                         player[0].targetanimation == walljumpleftkickanim) &&
                                        ((player[i].aiupdatedelay < .15 && difficulty == 2) ||
                                         (player[i].aiupdatedelay < .08 && difficulty != 2)))) {
                                        player[i].crouchkeydown = 1;
                                    }
                            if(player[i].isRun() && !player[i].onground) {
                                if(player[i].coords.y >
                    ...
                    if(player[i].isCrouch() && weapons.bloody[player[i].weaponids[player[i].weaponactive]] &&
                       bloodtoggle && player[i].onterrain && player[i].numweapons && player[i].weaponactive != -1 &&
                    ...
                    if(!animation[player[i].targetanimation].attack &&
                       ...
                       player[i].targetanimation != backhandspringanim && player[i].targetanimation != dodgebackanim) {
                        ...
                        if((player[i].jumpkeydown && !player[i].jumpclimb) || player[i].jumpstart) {
                            ...
                            if(player[i].targetanimation == jumpupanim &&
                               (((!floatjump && !editorenabled) || !debugmode) ||
                                player[i].aitype != playercontrolled)) {
