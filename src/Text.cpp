...
void Text::glPrint(float x,
                   float y,
                   char* string,
                   int set,
                   float size,
                   float width,
                   float height) // Where The Printing Happens
{
    glPrint(x, y, string, set, size, width, height, 0, strlen(string));
}

void Text::_glPrint(float x,
                    float y,
                    char* string,
                    int set,
                    float size,
                    ...
                    int start,
                    int end,
                    int offset) // Where The Printing Happens
{
    if(set > 1) {
        set = 1;
    }
...
void Text::glPrint(float x,
                   ...
                   float height,
                   int start,
                   int end) // Where The Printing Happens
{
    _glPrint(x, y, string, set, size, width, height, start, end, 0);
}

void Text::glPrintOutline(float x,
                          float y,
                          char* string,
                          int set,
                          float size,
...
void Text::glPrintOutlined(float x,
                           float y,
                           char* string,
                           int set,
                           float size,
...
void Text::glPrintOutlined(float r,
                           float g,
                           float b,
                           float x,
                           float y,
