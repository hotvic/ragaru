...
inline Matrix3x3::Matrix3x3(float r1c1,
                            float r1c2,
                            float r1c3,
                            float r2c1,
                            float r2c2,
...
{
    float d = e11 * e22 * e33 - e11 * e32 * e23 + e21 * e32 * e13 - e21 * e12 * e33 + e31 * e12 * e23 - e31 * e22 * e13;
...
inline Matrix3x3 operator/(Matrix3x3 m, float s)
{
    return Matrix3x3(m.e11 / s, m.e12 / s, m.e13 / s, m.e21 / s, m.e22 / s, m.e23 / s, m.e31 / s, m.e32 / s, m.e33 / s);
}
