...
OPENAL_SAMPLE* samp[100] = {};
OPENAL_STREAM* strm[20] = {};
int channels[100] = { 0 };
bool cellophane = 0;
bool autoslomo = 0;
float blurness = 0;
...
int numaccounts = 0;
int accountactive = 0;
int accountdifficulty[10] = {};
int accountprogress[10] = {};
float accountpoints[10] = {};
float accounthighscore[10][50] = {};
float accountfasttime[10][50] = {};
bool accountunlocked[10][60] = {};
char accountname[10][256] = {};
float accountcampaignhighscore[10] = {};
float accountcampaignfasttime[10] = {};
float accountcampaignscore[10] = {};
float accountcampaigntime[10] = {};
int accountcampaignchoicesmade[10] = {};
int accountcampaignchoices[10][5000] = {};
bool won = 0;
