...
bool sphere_line_intersection(float x1,
                              float y1,
                              float z1,
                              float x2,
                              float y2,
                              ...
                              float z3,
                              float r);
bool sphere_line_intersection(XYZ* p1, XYZ* p2, XYZ* p3, float* r);
...
inline bool sphere_line_intersection(float x1,
                                     float y1,
                                     float z1,
                                     float x2,
                                     float y2,
                                     ...
                                     float r)
{
    ...
    c = square(x3) + square(y3) + square(z3) + square(x1) + square(y1) + square(z1) -
...
inline bool sphere_line_intersection(XYZ* p1, XYZ* p2, XYZ* p3, float* r)
{
    ...
    c = square(p3->x) + square(p3->y) + square(p3->z) + square(p1->x) + square(p1->y) + square(p1->z) -
