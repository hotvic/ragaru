...
void Person::CheckKick()
{
    ...
    if(hasvictim)
        if(targetanimation == rabbitkickanim && victim && victim != this && currentframe >= 2 &&
...
void Person::CatchFire()
{
    ...
    for(int i = 0; i < 10; i++) {
        ...
        if(!skeleton.free)
            flatfacing = DoRotation(DoRotation(DoRotation(skeleton.joints[howmany].position, 0, 0, tilt), tilt2, 0, 0),
                                    0,
                                    rotation,
                                    0) *
                             scale +
...
bool Person::isIdle()
{
    if(targetanimation == sleepanim || targetanimation == sitanim || targetanimation == talkidleanim ||
       targetanimation == hurtidleanim || targetanimation == bounceidleanim || targetanimation == talkidleanim ||
       targetanimation == fightidleanim || targetanimation == knifefightidleanim ||
       targetanimation == swordfightidleanim || targetanimation == swordfightidlebothanim ||
       targetanimation == fightsidestep || targetanimation == wolfidle)
        return 1;
    else
        return 0;
}
...
bool Person::wasIdle()
{
    if(currentanimation == sleepanim || currentanimation == talkidleanim || currentanimation == sitanim ||
       currentanimation == hurtidleanim || currentanimation == bounceidleanim || currentanimation == fightidleanim ||
       currentanimation == swordfightidleanim || currentanimation == swordfightidlebothanim ||
       currentanimation == knifefightidleanim || currentanimation == fightsidestep || currentanimation == wolfidle)
        return 1;
    else
        return 0;
}
int Person::getIdle()
{
    ...
    if(hasvictim && victim != this /*||(id==0&&attackkeydown)*/)
        if(/*(id==0&&attackkeydown)||*/ (!victim->dead && victim->aitype != passivetype &&
                                         ...
                                         aitype != searchtype && victim->id < numplayers)) {
...
bool Person::isRun()
{
    if(targetanimation == runanim || targetanimation == wolfrunanim || targetanimation == wolfrunninganim ||
       targetanimation == rabbitrunninganim)
        return 1;
    else
        return 0;
}
...
bool Person::wasRun()
{
    if(currentanimation == runanim || currentanimation == wolfrunanim || currentanimation == wolfrunninganim ||
       currentanimation == rabbitrunninganim)
        return 1;
    else
        return 0;
}
...
{
    if(currentanimation == landhardanim || currentanimation == wolflandhardanim)
        return 1;
    else
        return 0;
}
...
bool Person::isFlip()
{
    if(targetanimation == flipanim || targetanimation == frontflipanim || targetanimation == backflipanim ||
       targetanimation == rightflipanim || targetanimation == leftflipanim ||
       targetanimation == walljumprightkickanim || targetanimation == walljumpleftkickanim)
        return 1;
    else
        return 0;
}
...
bool Person::wasFlip()
{
    if(currentanimation == flipanim || currentanimation == frontflipanim || currentanimation == backflipanim ||
       currentanimation == rightflipanim || currentanimation == leftflipanim ||
       currentanimation == walljumprightkickanim || currentanimation == walljumpleftkickanim)
        return 1;
    else
        return 0;
}
...
{
    if(targetanimation == walljumpfrontanim || targetanimation == walljumpbackanim ||
       targetanimation == walljumpleftanim || targetanimation == walljumprightanim)
        return 1;
    else
        return 0;
}
...
void Person::DoBlood(float howmuch, int which)
{
    ...
    if(config.video_blood && tutoriallevel != 1) {
        if(bleeding <= 0 && spurt) {
            spurt = 0;
            for(int i = 0; i < 3; i++) {
                bloodvel = 0;
                if(!skeleton.free) {
                    bloodvel.z = 10;
                    bloodvel =
                        DoRotation(bloodvel, ((float)(rand() % 100)) / 4, rotation + ((float)(rand() % 100)) / 4, 0) *
                        scale;
                }
                if(skeleton.free) {
                    bloodvel -= DoRotation(
                        skeleton.forward * 10 * scale, ((float)(rand() % 100)) / 4, ((float)(rand() % 100)) / 4, 0);
                }
                if(skeleton.free)
                    bloodvel += DoRotation(skeleton.joints[skeleton.jointlabels[head]].velocity,
                                           ((float)(rand() % 100)) / 4,
                                           rotation + ((float)(rand() % 100)) / 4,
                                           0) *
                                scale;
                if(!skeleton.free)
                    bloodvel +=
                        DoRotation(velocity, ((float)(rand() % 100)) / 4, ((float)(rand() % 100)) / 4, 0) * scale;
                if(skeleton.free) {
                    sprites.MakeSprite(bloodsprite,
                                       skeleton.joints[skeleton.jointlabels[head]].position * scale + coords,
                                       bloodvel,
                                       1,
                                       1,
                                       1,
                                       .05,
                                       1);
                    sprites.MakeSprite(bloodflamesprite,
                                       skeleton.joints[skeleton.jointlabels[head]].position * scale + coords,
                                       bloodvel,
                                       1,
                                       1,
                ...
                if(!skeleton.free) {
                    sprites.MakeSprite(bloodsprite,
                                       DoRotation((skeleton.joints[skeleton.jointlabels[head]].position +
                                                   skeleton.joints[skeleton.jointlabels[neck]].position) /
                                                      2,
                                                  0,
                                                  rotation,
                                                  0) *
                ...
                for(int i = 0; i < 3; i++) {
                    if(rand() % 2 != 0) {
                        ...
                        if(!skeleton.free) {
                            ...
                            bloodvel =
                                DoRotation(
                                    bloodvel, ((float)(rand() % 100)) / 4, rotation + ((float)(rand() % 100)) / 4, 0) *
                                scale;
                        }
                        if(skeleton.free) {
                            bloodvel -= DoRotation(skeleton.forward * 10 * scale,
                                                   ((float)(rand() % 100)) / 4,
                                                   ((float)(rand() % 100)) / 4,
                                                   0);
                        }
                        ...
                        if(!skeleton.free)
                            bloodvel +=
                                DoRotation(velocity, ((float)(rand() % 100)) / 4, ((float)(rand() % 100)) / 4, 0) *
                                scale;
                        bloodvel *= .2;
                        if(skeleton.free) {
        ...
        if(config.video_decals) {
            ...
            if(creature == rabbittype)
                while(bloodText[bleedxint * 512 * 3 + bleedyint * 3 + 0] > which + 4 ||
                      ...
                      bleedyint < 10 || bleedxint > 500 || bleedyint > 500) {
                    bleedxint = abs(rand() % 512);
                    bleedyint = abs(rand() % 512);
                }
            if(creature == wolftype)
                while(wolfbloodText[bleedxint * 512 * 3 + bleedyint * 3 + 0] > which + 4 ||
                      wolfbloodText[bleedxint * 512 * 3 + bleedyint * 3 + 0] < which - 4 || bleedxint < 10 ||
                      bleedyint < 10 || bleedxint > 500 || bleedyint > 500) {
                    bleedxint = abs(rand() % 512);
                    bleedyint = abs(rand() % 512);
                }
...
void Person::DoBloodBig(float howmuch, int which)
{
    ...
    if(config.video_blood && config.video_decals && tutoriallevel != 1) {
        if(bleeding <= 0 && spurt) {
            spurt = 0;
            for(int i = 0; i < 3; i++) {
                bloodvel = 0;
        ...
        if(creature == rabbittype)
            for(i = 0; i < 512; i++) {
                for(j = 0; j < 512; j++) {
                    if(bloodText[i * 512 * 3 + j * 3 + 0] <= which + 4 &&
                       bloodText[i * 512 * 3 + j * 3 + 0] >= which - 4) {
                        if(i < startx)
                            startx = i;
                        if(j < starty)
                            starty = j;
        ...
        if(creature == wolftype)
            for(i = 0; i < 512; i++) {
                for(j = 0; j < 512; j++) {
                    if(wolfbloodText[i * 512 * 3 + j * 3 + 0] <= which + 4 &&
                       wolfbloodText[i * 512 * 3 + j * 3 + 0] >= which - 4) {
                        if(i < startx)
                            startx = i;
                        if(j < starty)
                            starty = j;
        ...
        if(creature == rabbittype)
            for(i = startx; i < endx; i++) {
                for(j = starty; j < endy; j++) {
                    if(bloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 + 0] <=
                           which + 4 &&
                       bloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 + 0] >=
                           which - 4) {
                        color = rand() % 85 + 170;
        ...
        if(creature == wolftype)
            for(i = startx; i < endx; i++) {
                for(j = starty; j < endy; j++) {
                    if(wolfbloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 + 0] <=
                           which + 4 &&
                       wolfbloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 + 0] >=
                           which - 4) {
                        color = rand() % 85 + 170;
                        where = i * skeleton.skinsize * 3 + j * 3;
                        if(skeleton.skinText[where + 0] > color / 2)
        ...
        if(config.video_detail != 2 || osx)
            DoMipmaps(5, 0, 0, skeleton.skinsize, skeleton.skinsize);
        else
            DoMipmaps(0, startx / realtexdetail, endx / realtexdetail, starty / realtexdetail, endy / realtexdetail);

        bleedxint = 0;
        bleedyint = 0;
        if(creature == rabbittype)
            while(bloodText[bleedxint * 512 * 3 + bleedyint * 3 + 0] > which + 4 ||
                  bloodText[bleedxint * 512 * 3 + bleedyint * 3 + 0] < which - 4 || bleedxint < 10 || bleedyint < 10 ||
                  bleedxint > 500 || bleedyint > 500) {
                bleedxint = abs(rand() % 512);
                bleedyint = abs(rand() % 512);
            }
        if(creature == wolftype)
    ...
    if(tutoriallevel != 1 && aitype != playercontrolled && bloodloss > damagetolerance * 2 / 3 &&
       bloodloss < damagetolerance && creature == rabbittype) {
        if(abs(rand() % 2) == 0) {
            aitype = gethelptype;
            lastseentime = 12;
        } else
...
bool Person::DoBloodBigWhere(float howmuch, int which, XYZ where)
{
    ...
    if(config.video_blood && config.video_decals && tutoriallevel != 1) {
        ...
        if(whichtri != -1) {
            ...
            coordsx = skeleton.drawmodel.Triangles[whichtri].gx[0] * bary.x +
                      skeleton.drawmodel.Triangles[whichtri].gx[1] * bary.y +
                      skeleton.drawmodel.Triangles[whichtri].gx[2] * bary.z;
            coordsy = skeleton.drawmodel.Triangles[whichtri].gy[0] * bary.x +
                      skeleton.drawmodel.Triangles[whichtri].gy[1] * bary.y +
                      skeleton.drawmodel.Triangles[whichtri].gy[2] * bary.z;
                    ...
                    for(j = starty; j < endy; j++) {
                        if(bloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 + 0] <=
                           ...
                           bloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 + 0] >=
                            ...
                            skeleton.skinText[where + 1] = 0;
                            skeleton.skinText[where + 2] = 0;
                        } else if(bloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 +
                                            0] <= 160 + 4 &&
                                  bloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 +
                                            0] >= 160 - 4) {
                            color = rand() % 85 + 170;
                            where = i * skeleton.skinsize * 3 + j * 3;
                            if(skeleton.skinText[where + 0] > color / 2)
            ...
            if(creature == wolftype)
                for(i = startx; i < endx; i++) {
                    for(j = starty; j < endy; j++) {
                        if(wolfbloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 +
                                         0] <= which + 4 &&
                           wolfbloodText[(i * texdetailint - offsetx) * 512 * 3 + (j * texdetailint - offsety) * 3 +
                                         0] >= which - 4) {
                            color = rand() % 85 + 170;
                            where = i * skeleton.skinsize * 3 + j * 3;
                            if(skeleton.skinText[where + 0] > color / 2)
                            ...
                            skeleton.skinText[where + 1] = 0;
                            skeleton.skinText[where + 2] = 0;
                        } else if(wolfbloodText[(i * texdetailint - offsetx) * 512 * 3 +
                                                (j * texdetailint - offsety) * 3 + 0] <= 160 + 4 &&
                                  wolfbloodText[(i * texdetailint - offsetx) * 512 * 3 +
                                                (j * texdetailint - offsety) * 3 + 0] >= 160 - 4) {
                            color = rand() % 85 + 170;
                            where = i * skeleton.skinsize * 3 + j * 3;
                            if(skeleton.skinText[where + 0] > color / 2)
            ...
            if(config.video_detail != 2 || osx)
                ...
                DoMipmaps(
                    0, startx / realtexdetail, endx / realtexdetail, starty / realtexdetail, endy / realtexdetail);
...
void Person::DoMipmaps(int howmanylevels, float startx, float endx, float starty, float endy)
{
    ...
    if((!osx || howmanylevels)) {
        ...
        if((endx > startx && endy > starty) || howmanylevels) {
            ...
            for(i = startx; i < endx; i++) {
                for(j = starty; j < endy; j++) {
                    texturearray[(i - newstartx) * (newendy - newstarty) * 3 + (j - newstarty) * 3 + 0] =
                        skeleton.skinText[i * skeleton.skinsize * 3 + j * 3 + 0];
                    texturearray[(i - newstartx) * (newendy - newstarty) * 3 + (j - newstarty) * 3 + 1] =
                        skeleton.skinText[i * skeleton.skinsize * 3 + j * 3 + 1];
                    texturearray[(i - newstartx) * (newendy - newstarty) * 3 + (j - newstarty) * 3 + 2] =
                        skeleton.skinText[i * skeleton.skinsize * 3 + j * 3 + 2];
                }
            }
    ...
    if(victim->aitype == playercontrolled || hostiletime > 1)
        if(victim->targetanimation != jumpupanim && victim->targetanimation != jumpdownanim &&
           ((tutoriallevel != 1 || cananger) && hostile)) {
            if(normaldotproduct(victim->facing, victim->coords - coords) > 0 && !(victim->id == 0 && config.game_difficulty < 2) &&
               (creature != wolftype || victim->creature == wolftype))
                return;
            if(victim->aitype != playercontrolled && staggerdelay > 0)
                return;
            ...
            if(targetanimation == staffhitanim && findDistancefast(&victim->coords, &coords) < 2 &&
               ((victim->id == 0 && victim->crouchkeydown) || rand() % 4 == 0)) {
                if(victim->weaponactive != -1) {
                    ...
                    if(weapons.velocity[victim->weaponids[0]].x == 0)
                        weapons.velocity[victim->weaponids[0]].x = .1;
                    ...
                    if(victim->numweapons) {
                        ...
                        if(victim->weaponstuck == victim->numweapons)
            ...
            if(targetanimation == staffspinhitanim && findDistancefast(&victim->coords, &coords) < 2 &&
               ((victim->id == 0 && victim->crouchkeydown) || rand() % 2 == 0)) {
                if(victim->weaponactive != -1) {
                    victim->throwtogglekeydown = 1;
                    weapons.owner[victim->weaponids[0]] = -1;
                    weapons.velocity[victim->weaponids[0]] = victim->velocity * .2;
            ...
            if(targetanimation == swordslashanim && findDistancefast(&victim->coords, &coords) < 2 &&
               ((victim->id == 0 && victim->crouchkeydown) || rand() % 4 == 0)) {
                if(victim->weaponactive != -1) {
                    victim->throwtogglekeydown = 1;
                    weapons.owner[victim->weaponids[0]] = -1;
            ...
            if(targetanimation == knifeslashstartanim && findDistancefast(&victim->coords, &coords) < 2 &&
               (victim->id == 0 || rand() % 4 == 0)) {
                if(victim->weaponactive != -1) {
                    victim->throwtogglekeydown = 1;
                    weapons.owner[victim->weaponids[0]] = -1;
                    weapons.velocity[victim->weaponids[0]] = victim->velocity * .2;
            ...
            if(targetanimation != knifeslashstartanim && targetanimation != staffhitanim &&
               targetanimation != staffspinhitanim && targetanimation != winduppunchanim &&
               targetanimation != wolfslapanim && targetanimation != swordslashanim &&
            ...
            if((targetanimation == swordslashanim || targetanimation == staffhitanim ||
                targetanimation == staffspinhitanim) &&
               victim->weaponactive != -1) {
                ...
                if(abs(rand() % 20) == 0 || weapons.type[victim->weaponids[victim->weaponactive]] == knife) {
                    ...
                    if(victim->weaponactive != -1) {
                        if(weapons.type[victim->weaponids[0]] == staff || weapons.type[weaponids[0]] == staff) {
                            if(weapons.type[victim->weaponids[0]] == staff)
                                weapons.damage[victim->weaponids[0]] += .2 + float(abs(rand() % 100) - 50) / 250;
                            if(weapons.type[weaponids[0]] == staff)
                                weapons.damage[weaponids[0]] += .2 + float(abs(rand() % 100) - 50) / 250;
            ...
            if(hasvictim)
                if(targetanimation == knifeslashstartanim || targetanimation == swordslashanim ||
                   targetanimation == staffhitanim || targetanimation == staffspinhitanim) {
                    if((targetanimation != staffhitanim && targetanimation != staffspinhitanim) ||
                       findDistancefast(&coords, &victim->coords) > .2) {
                        ...
                        if(rotatetarget.z < 0)
                            victim->targetrotation = 180 - victim->targetrotation;
            ...
            if(aitype != playercontrolled)
                feint = 0;
            if(aitype != playercontrolled && rand() % 3 == 0 && escapednum < 2 && config.game_difficulty == 2)
                feint = 1;
            if(aitype != playercontrolled && rand() % 5 == 0 && escapednum < 2 && config.game_difficulty == 1)
                feint = 1;
            if(aitype != playercontrolled && rand() % 10 == 0 && escapednum < 2 && config.game_difficulty == 0)
                feint = 1;
...
void Person::DoDamage(float howmuch)
{
    ...
    if(id == 0 &&
       (bonus == solidhit || bonus == twoxcombo || bonus == threexcombo || bonus == fourxcombo || bonus == megacombo))
        bonus = 0;
    if(tutoriallevel != 1)
    ...
    if(aitype == passivetype && damage < damagetolerance && ((tutoriallevel != 1 || cananger) && hostile))
        aitype = attacktypecutoff;
    if(tutoriallevel != 1 && aitype != playercontrolled && damage < damagetolerance &&
       damage > damagetolerance * 2 / 3 && creature == rabbittype) {
        if(abs(rand() % 2) == 0) {
            aitype = gethelptype;
            lastseentime = 12;
        } else
    ...
    if(howmuch > damagetolerance * 50 && skeleton.free != 2) {
        ...
        for(int i = 0; i < skeleton.num_joints; i++) {
            ...
            if(!skeleton.free)
                flatfacing2 =
                    DoRotation(
                        DoRotation(DoRotation(skeleton.joints[i].position, 0, 0, tilt), tilt2, 0, 0), 0, rotation, 0) *
                        scale +
                    coords;
            if(skeleton.free)
...
void Person::DoHead()
{
    ...
    if(!freeze && !winfreeze && (!mainmenu || !gamestarted)) {
        ...
        while(targetheadrotation > 180)
            targetheadrotation -= 360;
        while(targetheadrotation < -180)
            targetheadrotation += 360;

        if(targetheadrotation > 160)
            targetheadrotation2 = targetheadrotation2 * -1;
        if(targetheadrotation < -160)
            targetheadrotation2 = targetheadrotation2 * -1;
        if(targetheadrotation > 160)
            targetheadrotation = targetheadrotation - 180;
        if(targetheadrotation < -160)
            targetheadrotation = targetheadrotation + 180;

        if(targetheadrotation2 > 120)
            targetheadrotation2 = 120;
        if(targetheadrotation2 < -120)
            targetheadrotation2 = -120;
        if(targetheadrotation > 120)
            targetheadrotation = 120;
        if(targetheadrotation < -120)
            targetheadrotation = -120;
        ...
        if(isIdle()) {
            if(targetheadrotation > 80)
                targetheadrotation = 80;
            if(targetheadrotation < -80)
                targetheadrotation = -80;
            if(targetheadrotation2 > 50)
                targetheadrotation2 = 50;
            if(targetheadrotation2 < -50)
                targetheadrotation2 = -50;
        }

        if(abs(headrotation - targetheadrotation) < multiplier * lookspeed)
            headrotation = targetheadrotation;
        ...
        if(abs(headrotation2 - targetheadrotation2) < multiplier * lookspeed / 2)
            headrotation2 = targetheadrotation2;
        ...
        skeleton.joints[skeleton.jointlabels[head]].position =
            rotatearound +
            DoRotation(skeleton.joints[skeleton.jointlabels[head]].position - rotatearound, headrotation2, 0, 0);

        facing = 0;
        facing.z = -1;
        if(targetanimation != bounceidleanim && targetanimation != fightidleanim && targetanimation != wolfidle &&
           targetanimation != knifefightidleanim && targetanimation != drawrightanim &&
           targetanimation != drawleftanim && targetanimation != walkanim) {
        ...
        for(i = 0; i < skeleton.num_muscles; i++) {
            if(skeleton.muscles[i].visible &&
               (skeleton.muscles[i].parent1->label == head || skeleton.muscles[i].parent2->label == head)) {
...
void Person::RagDoll(bool checkcollision)
{
    ...
    if(!skeleton.free) {
        ...
        for(i = 0; i < skeleton.num_joints; i++) {
            ...
            skeleton.joints[i].position = DoRotation(
                DoRotation(DoRotation(skeleton.joints[i].position, 0, 0, tilt), tilt2, 0, 0), 0, rotation, 0);
            if(!isnormal(skeleton.joints[i].position.x))
                skeleton.joints[i].position = DoRotation(skeleton.joints[i].position, 0, rotation, 0);
            if(!isnormal(skeleton.joints[i].position.x))
                skeleton.joints[i].position = skeleton.joints[i].position;
            if(!isnormal(skeleton.joints[i].position.x))
        ...
        for(i = 0; i < skeleton.num_joints; i++) {
            if((animation[currentanimation].attack != reversed || currentanimation == swordslashreversedanim) &&
               currentanimation != rabbitkickanim && !isLanding() && !wasLanding() &&
               animation[currentanimation].height == animation[targetanimation].height)
                skeleton.joints[i].velocity =
                    velocity / scale + facing * 5 +
                    DoRotation(DoRotation(DoRotation((animation[targetanimation].position[i][targetframe] -
                                                      animation[currentanimation].position[i][currentframe]) *
                                                         speed,
                                                     0,
                                                     0,
                                                     tilt),
        ...
        if(checkcollision) {
            ...
            if(terrain.patchobjectnum[whichpatchx][whichpatchz])
                for(l = 0; l < terrain.patchobjectnum[whichpatchx][whichpatchz]; l++) {
                    ...
                    lowpoint.y += 1;
                    if(SphereCheck(
                           &lowpoint, 3, &colpoint, &objects.position[i], &objects.rotation[i], &objects.model[i]) !=
                       -1) {
                        coords.x = lowpoint.x;
                        coords.z = lowpoint.z;
                    }
        ...
        if(rand() % 2 == 0) {
            if(weaponactive != -1 && targetanimation != rabbitkickanim && numweapons > 0) {
                weapons.owner[weaponids[0]] = -1;
                weapons.hitsomething[weaponids[0]] = 0;
                weapons.velocity[weaponids[0]] =
                    skeleton.joints[skeleton.jointlabels[righthand]].velocity * scale * -.3;
...
void Person::FootLand(int which, float opacity)
{
    ...
    if(opacity >= 1 || skiddelay <= 0)
    {
        if(opacity > 1) {
            ...
            if(which == 0)
                footpoint =
                    DoRotation(skeleton.joints[skeleton.jointlabels[leftfoot]].position, 0, rotation, 0) * scale +
                    coords;
            if(which == 1)
                footpoint =
                    DoRotation(skeleton.joints[skeleton.jointlabels[rightfoot]].position, 0, rotation, 0) * scale +
                    coords;
            // footpoint.y=coords.y;
            if(findDistancefast(&footpoint, &viewer))
                sprites.MakeSprite(cloudsprite, footpoint, footvel, 1, 1, 1, .5, .2 * opacity);
            ...
            if(findDistancefast(&footpoint, &viewer) < viewdistance * viewdistance / 4)
                sprites.MakeSprite(cloudsprite,
                                   footpoint,
                                   footvel * .6,
                                   terrainlight.x,
                                   terrainlight.y,
                                   ...
                                   .5,
                                   .7 * opacity);
            if(opacity >= 1 || config.video_detail == 2)
                if(config.video_detail == 2)
                    if(findDistancefast(&footpoint, &viewer) < viewdistance * viewdistance / 4)
                        terrain.MakeDecal(footprintdecal, footpoint, .2, 1 * opacity, rotation);
            ...
            if(findDistancefast(&footpoint, &viewer) < viewdistance * viewdistance / 4)
                sprites.MakeSprite(cloudsprite,
                                   footpoint,
                                   footvel * .6,
                                   terrainlight.x * 90 / 255,
                                   terrainlight.y * 70 / 255,
                                   terrainlight.z * 8 / 255,
                                   .5,
                                   .5 * opacity);
            ...
            if(findDistancefast(&footpoint, &viewer) < viewdistance * viewdistance / 4)
                sprites.MakeSprite(cloudsprite,
                                   footpoint,
                                   footvel * .6,
                                   terrainlight.x * 190 / 255,
                                   terrainlight.y * 170 / 255,
                                   terrainlight.z * 108 / 255,
                                   .5,
                                   .7 * opacity);
            if(opacity >= 1 || config.video_detail == 2)
                if(config.video_detail == 2)
                    if(findDistancefast(&footpoint, &viewer) < viewdistance * viewdistance / 4)
                        terrain.MakeDecal(footprintdecal, footpoint, .2, .25 * opacity, rotation);
...
void Person::DoAnimations()
{
    if(!skeleton.free) {
        ...
        if(isIdle() && currentanimation != getIdle())
        ...
        if(targetanimation == jumpupanim || targetanimation == jumpdownanim || isFlip()) {
            ...
            if(((velocity.y < -15) || (crouchkeydown && velocity.y < -8)) &&
               abs(velocity.y) * 4 > fast_sqrt(velocity.x * velocity.x * velocity.z * velocity.z))
                landhard = 1;
            if(!crouchkeydown && velocity.y >= -15)
                landhard = 0;
        }
        if((currentanimation == jumpupanim || targetanimation == jumpdownanim) /*&&velocity.y<40*/ && !isFlip() &&
           (!isLanding() && !isLandhard()) && ((crouchkeydown && !crouchtogglekeydown))) {
            XYZ targfacing;
            targfacing = 0;
            targfacing.z = 1;
        ...
        if(!crouchkeydown || (isLanding() || isLandhard()) || (wasLanding() || wasLandhard())) {
            ...
            if(!crouchtogglekeydown && animation[targetanimation].attack == reversed && aitype == playercontrolled &&
               (escapednum < 2 || reversaltrain))
                feint = 1;
            if(!isFlip())
                crouchtogglekeydown = 1;
        }

        if(animation[targetanimation].attack || currentanimation == getupfrombackanim ||
           currentanimation == getupfromfrontanim) {
        ...
        if(target >= 1) {
            ...
            if(targetanimation == rabbittacklinganim && targetframe == 1) {
                ...
                if(victim->aitype == attacktypecutoff && victim->stunned <= 0 && victim->surprised <= 0 &&
                   victim->id != 0)
                    Reverse();
                if(targetanimation == rabbittacklinganim && targetframe == 1 && !victim->isCrouch() &&
                   victim->targetanimation != backhandspringanim) {
                    if(normaldotproduct(victim->facing, facing) > 0)
                        victim->targetanimation = rabbittackledbackanim;
                    else
                        victim->targetanimation = rabbittackledfrontanim;
            ...
            if(!drawtogglekeydown && drawkeydown && (weaponactive == -1 || numweapons == 1) &&
               (animation[targetanimation].label[targetframe] ||
                (targetanimation != currentanimation && currentanimation == rollanim)) &&
               numweapons > 0 && creature != wolftype) {
            ...
            // Footstep sounds
            if(tutoriallevel != 1 || id == 0)
                if((animation[targetanimation].label[targetframe] &&
                    (animation[targetanimation].label[targetframe] < 5 ||
                     animation[targetanimation].label[targetframe] ==
                         8)) /*||(targetanimation==rollanim&&targetframe==animation[rollanim].numframes-1)*/) {
                    int whichsound;
                    float gLoc[3];
                    float vel[3];
                    gLoc[0] = coords.x;
                    ...
                    if(onterrain) {
                        if(terrain.getOpacity(coords.x, coords.z) < .2) {
                            if(animation[targetanimation].label[targetframe] == 1)
                                whichsound = footstepsound;
                            else
                                whichsound = footstepsound2;
                            if(animation[targetanimation].label[targetframe] == 1)
                                FootLand(0, 1);
                            if(animation[targetanimation].label[targetframe] == 2)
                                FootLand(1, 1);
                    ...
                    if(animation[targetanimation].label[targetframe] == 4 &&
                       (weaponactive == -1 ||
                        (targetanimation != knifeslashstartanim && targetanimation != knifethrowanim &&
                         targetanimation != crouchstabanim && targetanimation != swordgroundstabanim &&
                         targetanimation != knifefollowanim))) {
                    ...
                    } else if(animation[targetanimation].label[targetframe] == 4)
                        whichsound = knifeswishsound;
                    if(animation[targetanimation].label[targetframe] == 8 && tutoriallevel != 1)
                        whichsound = landsound2;

                    PlaySoundEx(whichsound, samp[whichsound], NULL, true);
                    OPENAL_3D_SetAttributes(channels[whichsound], gLoc, vel);
                    if(whichsound != knifeswishsound)
                        OPENAL_SetVolume(channels[whichsound], 128);
                    if(whichsound != knifeswishsound &&
                       (targetanimation == staffhitanim || targetanimation == staffgroundsmashanim ||
                        targetanimation == staffspinhitanim))
                        OPENAL_SetVolume(channels[whichsound], 256);
                    if(whichsound == knifeswishsound)
                        OPENAL_SetVolume(channels[whichsound], 512);
                    OPENAL_SetPaused(channels[whichsound], false);

                    if(id == 0)
                        if(whichsound == footstepsound || whichsound == footstepsound2 ||
                           whichsound == footstepsound3 || whichsound == footstepsound4) {
                            envsound[numenvsounds] = coords;
                            if(targetanimation == wolfrunninganim || targetanimation == rabbitrunninganim)
            ...
            if(tutoriallevel != 1 || id == 0)
                if(speechdelay <= 0)
                    if(targetanimation != crouchstabanim && targetanimation != swordgroundstabanim &&
            ...
            if(targetanimation == removeknifeanim && animation[targetanimation].label[currentframe] == 5) {
                for(i = 0; i < weapons.numweapons; i++) {
                    if(/*weapons.velocity[i].x==0&&weapons.velocity[i].y==0&&weapons.velocity[i].z==0&&*/ weapons
                           .owner[i] == -1)
                    ...
                    if(weapons.owner[i] != -1)
                        if(player[weapons.owner[i]].weaponstuck != -1)
                            if(player[weapons.owner[i]].weaponids[player[weapons.owner[i]].weaponstuck] == i)
                                if(player[weapons.owner[i]].numweapons > 1)
                                    willwork = 0;
                    if((/*weapons.velocity[i].x==0&&weapons.velocity[i].y==0&&weapons.velocity[i].z==0&&*/ weapons
                            .owner[i] == -1) ||
                       (hasvictim && weapons.owner[i] == victim->id && victim->skeleton.free))
                        if(willwork && findDistancefastflat(&coords, &weapons.position[i]) < 3 && weaponactive == -1) {
                            if(findDistancefast(&coords, &weapons.position[i]) < 1 || hasvictim) {
                                ...
                                if(weapons.owner[i] != -1) {
                                    ...
                                    if(victim->weaponstuck != -1) {
                                        if(victim->weaponids[victim->weaponstuck] == i) {
                                            if(config.video_blood)
                                                sprites.MakeSprite(
                                                    cloudimpactsprite, footpoint, footvel, 1, 0, 0, .8, .3);
                                            weapons.bloody[i] = 2;
                                    ...
                                    victim->skeleton.joints[victim->skeleton.jointlabels[abdomen]].velocity +=
                                        relative * 6;
                                    victim->skeleton.joints[victim->skeleton.jointlabels[neck]].velocity +=
                                        relative * 6;
                                    victim->skeleton.joints[victim->skeleton.jointlabels[rightshoulder]].velocity +=
                                        relative * 6;
                                    victim->skeleton.joints[victim->skeleton.jointlabels[leftshoulder]].velocity +=
                                        relative * 6;
                                }
                                weapons.owner[i] = id;
                                if(numweapons > 0) {
            ...
            if((currentanimation == walljumprightkickanim && targetanimation == walljumprightkickanim) ||
               (currentanimation == walljumpleftkickanim && targetanimation == walljumpleftkickanim)) {
            ...
            bool dojumpattack;
            dojumpattack = 0;
            if((targetanimation == rabbitrunninganim || targetanimation == wolfrunninganim) && targetframe == 3 &&
               (jumpkeydown || attackkeydown || id != 0))
                dojumpattack = 1;
            if(hasvictim)
                if(findDistancefast(&victim->coords, &/*player[i].*/ coords) < 5 && victim->aitype == gethelptype &&
                   (attackkeydown) && !victim->skeleton.free && victim->isRun() && victim->runninghowlong >= 1)
                    dojumpattack = 1;
            if(!hostile)
                dojumpattack = 0;
            if(dojumpattack) {
                ...
                if(closestid != -1)
                    if(closestdist < 5 && !player[closestid].dead &&
                       animation[player[closestid].targetanimation].height != lowheight &&
                       player[closestid].targetanimation != backhandspringanim) {
                        hasvictim = 1;
            ...
            if((animation[targetanimation].attack == normalattack || targetanimation == walljumprightkickanim ||
                targetanimation == walljumpleftkickanim) &&
               (!feint) && (victim->skeleton.free != 2 || targetanimation == killanim ||
                            targetanimation == dropkickanim || targetanimation == crouchstabanim ||
                            targetanimation == swordgroundstabanim || targetanimation == staffgroundsmashanim)) {
                if(targetanimation == spinkickanim && animation[targetanimation].label[currentframe] == 5) {
                    if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 3 && 3 &&
                       animation[victim->targetanimation].height != lowheight) {
                        ...
                        victim->skeleton.joints[victim->skeleton.jointlabels[head]].velocity +=
                            relative * damagemult * 200;
                        // FootLand(1,2);
                        victim->Puff(head);
                ...
                if(targetanimation == killanim && animation[targetanimation].label[currentframe] == 5) {
                    if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 9 && victim->dead) {
                        ...
                        victim->Puff(abdomen);
                        if(victim->dead != 2 && victim->permanentdamage > victim->damagetolerance - 250 && config.video_auto_slomo) {
                            slomo = 1;
                            slomodelay = .2;
                        }
                        victim->DoDamage(damagemult * 500 / victim->protectionhigh);
                        victim->skeleton.joints[victim->skeleton.jointlabels[abdomen]].velocity +=
                            relative * damagemult * 300;
                    }
                }
                ...
                if((targetanimation == crouchstabanim || targetanimation == swordgroundstabanim) &&
                   animation[targetanimation].label[currentframe] == 5) {
                    // if(findDistancefast(&coords,&victim->coords)<(scale*5)*(scale*5)*9){
                    ...
                    if(!hasvictim) {
                        terrain.MakeDecal(blooddecalfast,
                                          (weapons.tippoint[weaponids[weaponactive]] * .8 +
                                           weapons.position[weaponids[weaponactive]] * .2),
                                          .08,
                                          .6,
                                          rand() % 360);
                        PlaySoundEx(knifesheathesound, samp[knifesheathesound], NULL, true);
                    ...
                    if(victim && hasvictim) {
                        if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 3) {
                            ...
                            int whichtri;
                            if(weapons.type[weaponids[weaponactive]] == knife) {
                                where = (weapons.tippoint[weaponids[weaponactive]] * .6 +
                                         weapons.position[weaponids[weaponactive]] * .4);
                                where -= victim->coords;
                                if(!victim->skeleton.free)
                                    where = DoRotation(where, 0, -victim->rotation, 0);
                                // where=scale;
                                startpoint = where;
                                startpoint.y += 100;
                                endpoint = where;
                            ...
                            movepoint = 0;
                            rotationpoint = 0;
                            whichtri = victim->skeleton.drawmodel.LineCheck(
                                &startpoint, &endpoint, &colpoint, &movepoint, &rotationpoint);
                            ...
                            if(whichtri != -1) {
                                ...
                                if(config.video_blood)
                                    weapons.bloody[weaponids[weaponactive]] = 2;
                ...
                if((targetanimation == crouchstabanim || targetanimation == swordgroundstabanim) &&
                   animation[targetanimation].label[currentframe] == 6) {
                    // if(findDistancefast(&coords,&victim->coords)<(scale*5)*(scale*5)*9){
                    // if(id==0)camerashake+=.4;
                    float gLoc[3];
                    float vel[3];
                    ...
                    if(victim && hasvictim) {
                        ...
                        footvel = 0;
                        footpoint = (weapons.tippoint[weaponids[weaponactive]] * .8 +
                                     weapons.position[weaponids[weaponactive]] * .2);
                        ...
                        if(weapons.type[weaponids[weaponactive]] == sword) {
                            ...
                            rotationpoint = 0;
                            whichtri = victim->skeleton.drawmodel.LineCheck(
                                &startpoint, &endpoint, &footpoint, &movepoint, &rotationpoint);
                        ...
                        if(hasvictim) {
                            if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 3) {
                                ...
                                // victim->Puff(abdomen);
                                if(config.video_blood)
                                    sprites.MakeSprite(cloudimpactsprite, footpoint, footvel, 1, 0, 0, .8, .3);
                ...
                if(targetanimation == winduppunchanim && animation[targetanimation].label[currentframe] == 5) {
                    if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 2) {
                        ...
                        vel[2] = velocity.z;
                        // if(!victim->isIdle()||victim->damage>victim->damagetolerance-60){
                        if(victim->damage <= victim->damagetolerance - 60 &&
                           normaldotproduct(victim->facing, victim->coords - coords) < (scale * 5) * (scale * 5) * 0 &&
                           animation[victim->targetanimation].height != lowheight) {
                            if(tutoriallevel != 1) {
                                PlaySoundEx(thudsound, samp[thudsound], NULL, true);
                                OPENAL_3D_SetAttributes(channels[thudsound], gLoc, vel);
                        ...
                        } else if(victim->damage <= victim->damagetolerance - 60 &&
                                  normaldotproduct(victim->facing, victim->coords - coords) <
                                      (scale * 5) * (scale * 5) * 0 &&
                                  animation[victim->targetanimation].height == lowheight) {
                            if(tutoriallevel != 1) {
                                PlaySoundEx(whooshhitsound, samp[whooshhitsound], NULL, true);
                ...
                if(targetanimation == knifethrowanim && animation[targetanimation].label[currentframe] == 5) {
                    if(weaponactive != -1) {
                        ...
                        weapons.owner[weaponids[0]] = -1;
                        aim = victim->coords +
                              DoRotation(victim->skeleton.joints[victim->skeleton.jointlabels[abdomen]].position,
                                         0,
                                         victim->rotation,
                                         0) *
                                  victim->scale +
                              victim->velocity * findDistance(&victim->coords, &coords) / 50 -
                              (coords +
                               DoRotation(skeleton.joints[skeleton.jointlabels[righthand]].position, 0, rotation, 0) *
                                   scale);
                        Normalise(&aim);
                        /*if(victim->targetanimation==jumpupanim||victim->targetanimation==jumpdownanim){
                ...
                if(targetanimation == knifeslashstartanim && animation[targetanimation].label[currentframe] == 5) {
                    if(hasvictim)
                        if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 4.5 &&
                           /*animation[victim->targetanimation].height!=lowheight&&*/ victim->targetanimation !=
                               dodgebackanim &&
                           victim->targetanimation != rollanim) {
                            escapednum = 0;
                            // if(rand()%2){
                            if(tutoriallevel != 1)
                            ...
                            if(animation[victim->targetanimation].attack &&
                               (victim->aitype != playercontrolled || victim->targetanimation == knifeslashstartanim) &&
                               (victim->creature == rabbittype || victim->deathbleeding <= 0)) {
                                if(victim->id != 0 || config.game_difficulty == 2) {
                                    victim->targetframe = 0;
                                    victim->targetanimation = staggerbackhardanim;
                                    victim->targetrotation = targetrotation + 180;
                                    victim->target = 0;
                            ...
                            if(tutoriallevel != 1)
                                if(config.video_blood && !weapons.bloody[weaponids[weaponactive]])
                                    weapons.bloody[weaponids[weaponactive]] = 1;
                            if(tutoriallevel != 1)
                            ...
                            footvel = 0;
                            if(skeleton.free) {
                                footpoint = (victim->skeleton.joints[victim->skeleton.jointlabels[abdomen]].position +
                                             victim->skeleton.joints[victim->skeleton.jointlabels[neck]].position) /
                                                2 * victim->scale +
                                            victim->coords;
                            }
                            if(!skeleton.free) {
                                footpoint =
                                    DoRotation(
                                        (victim->skeleton.joints[victim->skeleton.jointlabels[abdomen]].position +
                                         victim->skeleton.joints[victim->skeleton.jointlabels[neck]].position) /
                                            2,
                                        0,
                                        victim->rotation,
                            ...
                            if(tutoriallevel != 1) {
                                if(config.video_blood)
                                    sprites.MakeSprite(cloudimpactsprite, footpoint, footvel, 1, 0, 0, .6, .3);
                                footvel = DoRotation(facing, 0, 90, 0) * .8;
                                // footvel.y-=.3;
                                sprites.MakeSprite(
                                    bloodsprite,
                                    footpoint,
                                    DoRotation(footvel * 7, (float)(rand() % 20), (float)(rand() % 20), 0),
                                    1,
                                    1,
                                    1,
                                    .05,
                                ...
                                sprites.MakeSprite(
                                    bloodsprite,
                                    footpoint,
                                    DoRotation(footvel * 3, (float)(rand() % 20), (float)(rand() % 20), 0),
                                    1,
                                    1,
                                    1,
                                    .05,
                ...
                if(targetanimation == swordslashanim && animation[targetanimation].label[currentframe] == 5 &&
                   victim->targetanimation != rollanim) {
                    if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 6.5 &&
                       victim->targetanimation != dodgebackanim) {
                        if(victim->weaponactive == -1 ||
                           normaldotproduct(victim->facing, victim->coords - coords) > 0 || (rand() % 2 == 0)) {
                            if(id == 0) {
                                bonus = Slashbonus;
                                bonustime = 0;
                                bonusvalue = 40;
                            ...
                            if(tutoriallevel != 1) {
                                ...
                                if(config.video_blood)
                                    sprites.MakeSprite(cloudimpactsprite, footpoint, footvel, 1, 0, 0, .9, .3);
                                footvel = DoRotation(facing, 0, 90, 0) * .8;
                                footvel.y -= .3;
                                sprites.MakeSprite(
                                    bloodsprite,
                            ...
                            if(victim->weaponactive != -1) {
                                if(weapons.type[victim->weaponids[0]] == staff || weapons.type[weaponids[0]] == staff) {
                                    if(weapons.type[victim->weaponids[0]] == staff)
                                        weapons.damage[victim->weaponids[0]] +=
                                            .2 + float(abs(rand() % 100) - 50) / 250;
                                    if(weapons.type[weaponids[0]] == staff)
                                        weapons.damage[weaponids[0]] += .2 + float(abs(rand() % 100) - 50) / 250;
                ...
                if(targetanimation == staffhitanim && animation[targetanimation].label[currentframe] == 5 &&
                   victim->targetanimation != rollanim) {
                    if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 6.5 &&
                       victim->targetanimation != dodgebackanim && victim->targetanimation != sweepanim) {
                        if(tutoriallevel != 1) {
                ...
                if(targetanimation == staffspinhitanim && animation[targetanimation].label[currentframe] == 5 &&
                   victim->targetanimation != rollanim) {
                    if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 6.5 &&
                       victim->targetanimation != dodgebackanim && victim->targetanimation != sweepanim) {
                        if(tutoriallevel != 1) {
                ...
                if(targetanimation == staffgroundsmashanim && animation[targetanimation].label[currentframe] == 5) {
                    if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 6.5) {
                        ...
                        if(tutoriallevel != 1) {
                            if(!victim->dead)
                                weapons.damage[weaponids[0]] += .4 + float(abs(rand() % 100) - 50) / 500;
                            if(id == 0)
                                camerashake += .4;
                            if(rand() % 2 || creature == wolftype) {
                                victim->spurt = 1;
                ...
                if(targetanimation == lowkickanim && animation[targetanimation].label[currentframe] == 5) {
                    if(findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 3 &&
                       animation[victim->targetanimation].height != highheight) {
                        escapednum = 0;
                        if(id == 0)
                            camerashake += .4;
                        float gLoc[3];
                ...
                if(targetanimation == sweepanim && animation[targetanimation].label[currentframe] == 5) {
                    if(victim->targetanimation != jumpupanim &&
                       findDistancefast(&coords, &victim->coords) < (scale * 5) * (scale * 5) * 3 && victim != this) {
                        escapednum = 0;
                        if(id == 0)
                            camerashake += .2;
                        float gLoc[3];
                        ...
                        if(animation[victim->targetanimation].height == middleheight ||
                           animation[victim->currentanimation].height == middleheight ||
                           victim->damage >= victim->damagetolerance - 40) {
                            victim->RagDoll(0);
                            ...
                            relative.y += .1;
                            for(i = 0; i < victim->skeleton.num_joints; i++) {
                                if(victim->skeleton.joints[i].label == leftfoot ||
                                   victim->skeleton.joints[i].label == rightfoot ||
                                   victim->skeleton.joints[i].label == leftankle ||
                                   victim->skeleton.joints[i].label == rightankle)
            ...
            if(animation[targetanimation].attack == reversal &&
               (!victim->feint || (victim->lastattack == victim->lastattack2 &&
                                   victim->lastattack2 == victim->lastattack3 && rand() % 2) ||
                targetanimation == knifefollowanim)) {
                ...
                if((targetanimation == swordslashreversalanim || targetanimation == knifeslashreversalanim ||
                    targetanimation == staffhitreversalanim || targetanimation == staffspinhitreversalanim) &&
                   animation[targetanimation].label[currentframe] == 5) {
                ...
                if(targetanimation == swordslashreversalanim && animation[targetanimation].label[currentframe] == 7) {
                    ...
                    OPENAL_SetVolume(channels[knifeslicesound], 512);
                    OPENAL_SetPaused(channels[knifeslicesound], false);
                    if(config.video_blood&&!weapons.bloody[weaponids[weaponactive]])weapons.bloody[weaponids[weaponactive]]=1;
                    weapons.blooddrip[weaponids[weaponactive]]+=3;
                    }*/
                }

                if(hasvictim && targetanimation == knifeslashreversalanim &&
                   animation[targetanimation].label[currentframe] == 7) {
                    escapednum = 0;
                    if(id == 0)
                        camerashake += .4;
                    if(rand() % 2) {
                ...
                if(hasvictim && targetanimation == sneakattackanim &&
                   animation[targetanimation].label[currentframe] == 7) {
                    escapednum = 0;
                    victim->RagDoll(0);
                ...
                if(hasvictim && (targetanimation == knifefollowanim || targetanimation == knifesneakattackanim) &&
                   animation[targetanimation].label[currentframe] == 5) {
                    if(weaponactive != -1 && victim->bloodloss < victim->damagetolerance) {
                        ...
                        if(targetanimation == knifesneakattackanim) {
                            ...
                            sprites.MakeSprite(bloodsprite,
                            DoRotation(skeleton.joints[skeleton.jointlabels[neck]].position,0,rotation,0)*scale+coords,bloodvel,
                            1,1,1, .05, 1);
                            */
                            XYZ footvel, footpoint;
                            footvel = 0;
                ...
                if(hasvictim && (targetanimation == swordsneakattackanim) &&
                   animation[targetanimation].label[currentframe] == 5) {
                    if(weaponactive != -1 && victim->bloodloss < victim->damagetolerance) {
                        if(id == 0) {
                            bonus = backstab;
                        ...
                        sprites.MakeSprite(bloodflamesprite,
                                           footpoint,
                                           DoRotation(footvel * 5, (float)(rand() % 20), (float)(rand() % 20), 0),
                                           1,
                                           1,
                                           1,
                                           .3,
                ...
                if(targetanimation == sweepreversalanim &&
                   ((animation[targetanimation].label[currentframe] == 9 && victim->damage < victim->damagetolerance) ||
                    (animation[targetanimation].label[currentframe] == 7 &&
                     victim->damage > victim->damagetolerance))) {
                    escapednum = 0;
                    victim->RagDoll(0);
                ...
                if(hasvictim && (targetanimation == spinkickreversalanim || targetanimation == sweepreversalanim ||
                                 targetanimation == rabbitkickreversalanim || targetanimation == upunchreversalanim ||
                                 targetanimation == jumpreversalanim || targetanimation == swordslashreversalanim ||
                                 targetanimation == knifeslashreversalanim || targetanimation == rabbittacklereversal ||
                                 targetanimation == wolftacklereversal || targetanimation == staffhitreversalanim ||
                                 targetanimation == staffspinhitreversalanim))
            ...
            if(targetframe > animation[currentanimation].numframes - 1) {
                ...
                if(targetanimation == walljumprightanim || targetanimation == walljumpbackanim ||
                   targetanimation == walljumpfrontanim) {
                ...
                if(animation[targetanimation].attack == reversal && currentanimation != sneakattackanim &&
                   currentanimation != knifesneakattackanim && currentanimation != swordsneakattackanim &&
                   currentanimation != knifefollowanim) {
                ...
                if(animation[targetanimation].attack == reversed) {
                    escapednum++;
                    if(targetanimation == sweepreversedanim)
                        targetrotation += 90;
                    ...
                    if(currentanimation == upunchreversedanim || currentanimation == swordslashreversedanim) {
                        ...
                        oldcoords = coords;
                        coords +=
                            (DoRotation(skeleton.joints[skeleton.jointlabels[leftfoot]].position, 0, rotation, 0) +
                             DoRotation(skeleton.joints[skeleton.jointlabels[rightfoot]].position, 0, rotation, 0)) /
                            2 * scale;
                ...
                if(wasLandhard())
                    targetanimation = getIdle();
                if(currentanimation == spinkickanim || currentanimation == getupfrombackanim ||
                   currentanimation == getupfromfrontanim || currentanimation == lowkickanim) {
                    targetanimation = getIdle();
                    oldcoords = coords;
                    coords += (DoRotation(skeleton.joints[skeleton.jointlabels[leftfoot]].position, 0, rotation, 0) +
                               DoRotation(skeleton.joints[skeleton.jointlabels[rightfoot]].position, 0, rotation, 0)) /
                              2 * scale;
                    coords.y = oldcoords.y;
                ...
                if(animation[currentanimation].attack == normalattack && !victim->skeleton.free &&
                   victim->targetanimation != staggerbackhighanim && victim->targetanimation != staggerbackhardanim &&
                   targetanimation != winduppunchblockedanim && targetanimation != blockhighleftanim &&
                   targetanimation != swordslashparryanim && targetanimation != swordslashparriedanim &&
                   targetanimation != crouchstabanim && targetanimation != swordgroundstabanim) {
                ...
                if(currentanimation == knifeslashstartanim || currentanimation == knifethrowanim ||
                   currentanimation == swordslashanim || currentanimation == staffhitanim ||
                   currentanimation == staffgroundsmashanim || currentanimation == staffspinhitanim) {
                    targetanimation = getIdle();
                    lastfeint = 0;
                }
                if(currentanimation == spinkickanim && victim->skeleton.free) {
                    if(creature == rabbittype)
                        targetanimation = fightidleanim;
                }
            }
            target = 0;
        ...
        if(!skeleton.free) {
            ...
            if(!transspeed && animation[targetanimation].attack != 2 && animation[targetanimation].attack != 3) {
                ...
                if(isRun() && wasRun()) {
                    ...
                    target += multiplier * animation[targetanimation].speed[currentframe] * speed * 1.7 * tempspeed /
                              (speed * 45 * scale);
                }
            } else if(transspeed)
            ...
            if(currentanimation != oldcurrentanimation || targetanimation != oldtargetanimation ||
               ((currentframe != oldcurrentframe || targetframe != oldtargetframe) && !calcrot)) {
                // Old rotates
                for(i = 0; i < skeleton.num_joints; i++) {
                ...
                for(i = 0; i < skeleton.num_muscles; i++) {
                    if(skeleton.muscles[i].visible) {
                        if(isnormal((float)((int)(skeleton.muscles[i].rotate1 * 100) % 36000) / 100))
                            skeleton.muscles[i].oldrotate1 =
                                (float)((int)(skeleton.muscles[i].rotate1 * 100) % 36000) / 100;
                        if(isnormal((float)((int)(skeleton.muscles[i].rotate2 * 100) % 36000) / 100))
                            skeleton.muscles[i].oldrotate2 =
                                (float)((int)(skeleton.muscles[i].rotate2 * 100) % 36000) / 100;
                        if(isnormal((float)((int)(skeleton.muscles[i].rotate3 * 100) % 36000) / 100))
                            skeleton.muscles[i].oldrotate3 =
                                (float)((int)(skeleton.muscles[i].rotate3 * 100) % 36000) / 100;
                    }
                }
                ...
                for(i = 0; i < skeleton.num_muscles; i++) {
                    if(skeleton.muscles[i].visible) {
                        if(isnormal((float)((int)(skeleton.muscles[i].rotate1 * 100) % 36000) / 100))
                            skeleton.muscles[i].newrotate1 =
                                (float)((int)(skeleton.muscles[i].rotate1 * 100) % 36000) / 100;
                        if(isnormal((float)((int)(skeleton.muscles[i].rotate2 * 100) % 36000) / 100))
                            skeleton.muscles[i].newrotate2 =
                                (float)((int)(skeleton.muscles[i].rotate2 * 100) % 36000) / 100;
                        if(isnormal((float)((int)(skeleton.muscles[i].rotate3 * 100) % 36000) / 100))
                            skeleton.muscles[i].newrotate3 =
                                (float)((int)(skeleton.muscles[i].rotate3 * 100) % 36000) / 100;
            ...
            if(currentframe >= animation[currentanimation].numframes)
                currentframe = animation[currentanimation].numframes - 1;
            ...
            for(i = 0; i < skeleton.num_joints; i++) {
                skeleton.joints[i].velocity =
                    (animation[currentanimation].position[i][currentframe] * (1 - target) +
                     animation[targetanimation].position[i][targetframe] * (target)-skeleton.joints[i].position) /
                    multiplier;
                skeleton.joints[i].position = animation[currentanimation].position[i][currentframe] * (1 - target) +
                                              animation[targetanimation].position[i][targetframe] * (target);
            }
            offset = currentoffset * (1 - target) + targetoffset * target;
            for(i = 0; i < skeleton.num_muscles; i++) {
                if(skeleton.muscles[i].visible) {
                    skeleton.muscles[i].rotate1 =
                        skeleton.muscles[i].oldrotate1 * (1 - target) + skeleton.muscles[i].newrotate1 * (target);
                    skeleton.muscles[i].rotate2 =
                        skeleton.muscles[i].oldrotate2 * (1 - target) + skeleton.muscles[i].newrotate2 * (target);
                    skeleton.muscles[i].rotate3 =
                        skeleton.muscles[i].oldrotate3 * (1 - target) + skeleton.muscles[i].newrotate3 * (target);
                }
            }
        }
...
void Person::DoStuff()
{
    ...
    if(numweapons == 1 && weaponactive != -1)
        weaponstuck = -1;
    ...
    if(id != 0 && (creature == rabbittype || config.game_difficulty != 2))
        superruntoggle = 0;
    if(id != 0 && creature == wolftype && config.game_difficulty == 2) {
        superruntoggle = 0;
        if(aitype != passivetype) {
            superruntoggle = 1;
            if(aitype == attacktypecutoff &&
               (player[0].isIdle() || player[0].isCrouch() || player[0].skeleton.free ||
                player[0].targetanimation == getupfrombackanim || player[0].targetanimation == getupfromfrontanim ||
                player[0].targetanimation == sneakanim) &&
               findDistancefast(&coords, &player[0].coords) < 16) {
                superruntoggle = 0;
            }
        }
        if(scale < 0.2)
    ...
    while(flamedelay < 0 && onfire) {
        ...
        if(skeleton.free)
            flatfacing = skeleton.joints[howmany].position * scale + coords;
        sprites.MakeSprite(
            flamesprite, flatfacing, flatvelocity, 1, 1, 1, .6 + (float)abs(rand() % 100) / 200 - .25, 1);
    }
    ...
    while(flamedelay < 0 && !onfire && tutoriallevel == 1 && id != 0) {
        ...
        if(skeleton.free)
            flatfacing = skeleton.joints[howmany].position * scale + coords;
        sprites.MakeSprite(
            breathsprite, flatfacing, flatvelocity, 1, 1, 1, .6 + (float)abs(rand() % 100) / 200 - .25, .3);
    }
    ...
    if(bleeding > 0) {
        ...
        if(config.video_blood == 2) {
            glBindTexture(GL_TEXTURE_2D, skeleton.drawmodel.textureptr);
            if(bleeding <= 0 && (config.video_detail != 2 || osx))
                DoMipmaps(5, 0, 0, skeleton.skinsize, skeleton.skinsize);
        }
    }
    ...
    if(neckspurtamount > 0) {
        ...
        if(neckspurtparticledelay < 0 && neckspurtdelay > 2) {
            ...
            if(!skeleton.free) {
                ...
                bloodvel =
                    DoRotation(bloodvel, ((float)(rand() % 100)) / 40, rotation + ((float)(rand() % 100)) / 40, 0) *
                    scale;
            }
            if(skeleton.free) {
                bloodvel -= DoRotation(
                    skeleton.forward * 10 * scale, ((float)(rand() % 100)) / 40, ((float)(rand() % 100)) / 40, 0);
            }
            if(skeleton.free)
                bloodvel += DoRotation(skeleton.joints[skeleton.jointlabels[head]].velocity,
                                       ((float)(rand() % 100)) / 40,
                                       rotation + ((float)(rand() % 100)) / 40,
                                       0) *
                            scale;
            if(!skeleton.free)
            ...
            if(!skeleton.free)
                sprites.MakeSprite(bloodsprite,
                                   DoRotation(skeleton.joints[skeleton.jointlabels[neck]].position +
                                                  (skeleton.joints[skeleton.jointlabels[neck]].position -
                                                   skeleton.joints[skeleton.jointlabels[head]].position) /
                                                      5,
                                              0,
    ...
    if(deathbleeding > 0 && dead != 2) {
        ...
        if(bleeddelay < 0 && config.video_blood) {
            bleeddelay = 1;
            XYZ bloodvel;
            if(config.video_blood) {
                bloodvel = 0;
                if(skeleton.free)
                    bloodvel += DoRotation(skeleton.joints[skeleton.jointlabels[abdomen]].velocity,
                                           ((float)(rand() % 100)) / 4,
                                           rotation + ((float)(rand() % 100)) / 4,
                                           0) *
                                scale;
                ...
                if(skeleton.free)
                    sprites.MakeSprite(bloodsprite,
                                       skeleton.joints[skeleton.jointlabels[abdomen]].position * scale + coords,
                                       bloodvel,
                                       1,
                                       1,
                                       1,
                ...
                if(!skeleton.free)
                    sprites.MakeSprite(bloodsprite,
                                       DoRotation((skeleton.joints[skeleton.jointlabels[abdomen]].position +
                                                   skeleton.joints[skeleton.jointlabels[abdomen]].position) /
                                                      2,
                                                  0,
                                                  rotation,
                                                  0) *
    ...
    if(texupdatedelay < 0 && bleeding > 0 && config.video_blood == 2 && findDistancefast(&viewer, &coords) < 9) {
        texupdatedelay = .12;
    ...
    if(dead != 2 && howactive <= typesleeping) {
        ...
        if(chestmorphstart != 0 && chestmorphend != 0) {
            ...
            if(environment == snowyenvironment) {
                ...
                XYZ footvel;
                if(!skeleton.free)
                    footvel = DoRotation(skeleton.specialforward[0], 0, rotation, 0) * -1;
                if(skeleton.free)
                    footvel = skeleton.specialforward[0] * -1;
                if(!skeleton.free)
                    footpoint = DoRotation((skeleton.joints[skeleton.jointlabels[head]].position +
                                            skeleton.joints[skeleton.jointlabels[neck]].position) /
                                               2,
                                           0,
                                           rotation,
                                ...
                                coords;
                if(skeleton.free)
                    footpoint = ((skeleton.joints[skeleton.jointlabels[head]].position +
                                  skeleton.joints[skeleton.jointlabels[neck]].position) /
                                 2) *
                                    scale +
                                coords;
    ...
    if(creature == wolftype) {
        twitchdelay2 -= multiplier * 1.5;
        if(tailmorphend != 0)
            if((isRun() || targetanimation == jumpupanim || targetanimation == jumpdownanim ||
                targetanimation == backflipanim) &&
               !skeleton.free) {
                tailmorphness = 0;
                targettailmorphness = 1;
        ...
        if(tailmorphend != 5)
            if(targetanimation == flipanim || targetanimation == frontflipanim || targetanimation == rollanim ||
               skeleton.free) {
                tailmorphness = 0;
                targettailmorphness = 1;
                tailmorphend = 5;
    ...
    if(damage > damagetolerance && !dead) {
        ...
        if((id == 0 || findDistancefast(&coords, &viewer) < 50) && config.video_auto_slomo) {
            slomo = 1;
            slomodelay = .2;
        }
    ...
    if(permanentdamage > damagetolerance && dead != 2) {
        ...
        if(id != 0 && unconscioustime < .1 && (bonus != spinecrusher || bonustime > 1) &&
           (bonus != FinishedBonus || bonustime > 1) && bloodloss < damagetolerance) {
            bonus = touchofdeath;
            bonustime = 0;
            bonusvalue = 150;
        }
    ...
    if(skeleton.free == 1) {
        ...
        if(id != 0 && damage > damagetolerance - damageamount && !dead && (bonus != spinecrusher || bonustime > 1) &&
           (bonus != style || bonustime > 1) && (bonus != cannon || bonustime > 1)) {
            bonus = deepimpact;
            bonustime = 0;
            bonusvalue = 50;
        }
        ...
        if(findLength(&average) < 10 && dead && skeleton.free) {
            ...
            if(skeleton.longdead > 2000) {
                ...
                if(dead == 2 && bloodloss < damagetolerance) {
                    XYZ headpoint;
                    headpoint = (skeleton.joints[skeleton.jointlabels[head]].position +
                                 skeleton.joints[skeleton.jointlabels[neck]].position) /
                                    2 * scale +
                                coords;
                    DoBlood(1, 255);
                ...
                if(dead == 2 && bloodloss >= damagetolerance) {
                    XYZ headpoint;
                    headpoint = (skeleton.joints[skeleton.jointlabels[abdomen]].position +
                                 skeleton.joints[skeleton.jointlabels[neck]].position) /
                                    2 * scale +
                                coords;
                    if(bleeding <= 0)
        ...
        if(!dead && crouchkeydown && skeleton.freetime > .5 && id == 0 && skeleton.free) {
            ...
            if(canrecover) {
                ...
                terrainnormal = skeleton.joints[skeleton.jointlabels[groin]].position -
                                skeleton.joints[skeleton.jointlabels[abdomen]].position;
                if(skeleton.joints[skeleton.jointlabels[groin]].locked &&
                   skeleton.joints[skeleton.jointlabels[abdomen]].locked) {
                    terrainnormal = skeleton.joints[skeleton.jointlabels[groin]].position -
                                    skeleton.joints[skeleton.jointlabels[abdomen]].position;
                    middle = (skeleton.joints[skeleton.jointlabels[groin]].position +
                              skeleton.joints[skeleton.jointlabels[abdomen]].position) /
                             2;
                }
                if(skeleton.joints[skeleton.jointlabels[abdomen]].locked &&
                   skeleton.joints[skeleton.jointlabels[neck]].locked) {
                    terrainnormal = skeleton.joints[skeleton.jointlabels[abdomen]].position -
                                    skeleton.joints[skeleton.jointlabels[neck]].position;
                    middle = (skeleton.joints[skeleton.jointlabels[neck]].position +
                              skeleton.joints[skeleton.jointlabels[abdomen]].position) /
                             2;
                }
                if(skeleton.joints[skeleton.jointlabels[groin]].locked &&
        ...
        if(findLength(&average) < 10 && !dead && skeleton.free) {
            ...
            if(skeleton.longdead > (damage + 500) * 1.5) {
                ...
                */
                ...
                if((rand() % 8 == 0 && id != 0 && creature == rabbittype) ||
                   (rand() % 2 == 0 && id != 0 && creature == wolftype) ||
                   (id == 0 && crouchkeydown && (forwardkeydown || backkeydown || leftkeydown || rightkeydown))) {
                    targetanimation = rollanim;
        ...
        if(numweapons > 0)
            if(weapons.type[0] == staff)
                hasstaff = 1;
        if(!skeleton.freefall && freefall &&
           ((jumpkeydown && jumpkeydowntime < .2) || (hasstaff && rabbitkickragdoll)) && !dead) {
            if(velocity.y > -30) {
                XYZ tempvelocity;
        ...
        if(findLengthfast(&velocity) > .1)
            for(i = 0; i < objects.numobjects; i++) {
                if(objects.type[i] == firetype)
                    if(findDistancefastflat(&coords, &objects.position[i]) < objects.scale[i] * objects.scale[i] * 12 &&
                       findDistancefast(&coords, &objects.position[i]) < objects.scale[i] * objects.scale[i] * 49) {
                        if(onfire) {
                            if(!objects.onfire[i]) {
                                float gLoc[3];
                                float vel[3];
                            ...
                            if(config.video_detail == 2)
                                if(environment != desertenvironment)
                                    for(j = 0; j < howmany; j++) {
                                        ...
                                        sprites.MakeSprite(splintersprite,
                                                           pos,
                                                           tempvel * .5 + velocity * float(abs(rand() % 100)) / 100,
                                                           165 / 255 + float(abs(rand() % 100) - 50) / 400,
                                                           0,
                                                           0,
                                                           .2 + float(abs(rand() % 100) - 50) / 1300,
                                                           1);
                            ...
                            if(config.video_detail == 2)
                                if(environment == snowyenvironment)
                                    for(j = 0; j < howmany; j++) {
                                        ...
                                        sprites.MakeSprite(splintersprite,
                                                           pos,
                                                           tempvel * .3 + velocity * float(abs(rand() % 100)) / 100 / 2,
                                                           1,
                                                           1,
                                                           1,
                                                           .1,
                ...
                if(objects.type[i] == treeleavestype && environment != desertenvironment) {
                    ...
                    if(findDistancefastflat(&tempcoord, &objects.position[i]) <
                           objects.scale[i] * objects.scale[i] * 8 &&
                       findDistancefast(&tempcoord, &objects.position[i]) < objects.scale[i] * objects.scale[i] * 300 &&
                       tempcoord.y > objects.position[i].y + 3 * objects.scale[i]) {
                        /*if(onfire){
                        if(!objects.onfire[i]){
                        float gLoc[3];
                        float vel[3];
    ...
    if(!skeleton.free) {
        ...
        if(targetanimation == staggerbackhighanim)
            staggerdelay = 1;
        if(targetanimation == staggerbackhardanim)
            staggerdelay = 1;
        staggerdelay -= multiplier;
        if(targetanimation != crouchstabanim && targetanimation != swordgroundstabanim &&
           targetanimation != staffgroundsmashanim)
            hasvictim = 1;
        if(velocity.y < -30 && targetanimation == jumpdownanim)
            RagDoll(0);
        ...
        if(targetanimation == bounceidleanim || targetanimation == wolfidle || targetanimation == walkanim ||
           targetanimation == drawrightanim || targetanimation == crouchdrawrightanim ||
           targetanimation == drawleftanim || targetanimation == fightidleanim || targetanimation == fightsidestep ||
           targetanimation == hanganim || isCrouch() || targetanimation == backhandspringanim) {
            ...
            if(headmorphend != 3 && headmorphend != 5 && headmorphstart != 3 && headmorphstart != 5 &&
               headmorphend != 0 && headmorphness == targetheadmorphness) {
                headmorphness = 0;
                headmorphend = 0;
                targetheadmorphness = 1;
            }
        ...
        if(targetanimation == rollanim || targetanimation == dodgebackanim || targetanimation == removeknifeanim ||
           targetanimation == knifefightidleanim || targetanimation == swordfightidleanim ||
           targetanimation == blockhighleftstrikeanim || targetanimation == crouchremoveknifeanim ||
           targetanimation == sneakanim || targetanimation == sweepanim || targetanimation == spinkickreversedanim ||
           targetanimation == jumpdownanim || isWallJump() || isFlip() || targetanimation == climbanim || isRun() ||
           targetanimation == getupfrombackanim || targetanimation == getupfromfrontanim) {
        ...
        if(targetanimation == jumpupanim || targetanimation == crouchstabanim ||
           targetanimation == swordgroundstabanim || targetanimation == swordfightidlebothanim ||
           targetanimation == blockhighleftanim || targetanimation == blockhighleftanim) {
        ...
        if(targetanimation == spinkickanim || targetanimation == staffspinhitreversalanim ||
           targetanimation == staffspinhitreversedanim || targetanimation == staffhitreversalanim ||
           targetanimation == staffhitreversedanim || targetanimation == hurtidleanim ||
           targetanimation == winduppunchanim || targetanimation == swordslashreversalanim ||
           targetanimation == swordslashreversedanim || targetanimation == knifeslashreversalanim ||
           targetanimation == knifeslashreversedanim || targetanimation == knifethrowanim ||
           targetanimation == knifefollowanim || targetanimation == knifefollowedanim || targetanimation == killanim ||
           targetanimation == dropkickanim || targetanimation == upunchanim || targetanimation == knifeslashstartanim ||
           targetanimation == swordslashanim || targetanimation == staffhitanim ||
           targetanimation == staffspinhitanim || targetanimation == staffgroundsmashanim ||
           targetanimation == spinkickreversalanim || targetanimation == sweepreversalanim ||
           targetanimation == lowkickanim || targetanimation == sweepreversedanim ||
           targetanimation == rabbitkickreversalanim || targetanimation == rabbitkickreversedanim ||
           targetanimation == jumpreversalanim || targetanimation == jumpreversedanim) {
        ...
        */
        ...
        behind = 0;
        if(hasvictim) {
            if(victim != this && !victim->dead && victim->aitype != passivetype && victim->aitype != searchtype &&
               aitype != passivetype && aitype != searchtype && victim->id < numplayers && aitype != passivetype) {
                behind = (normaldotproduct(facing, coords - victim->coords) > 0);
            }
        }

        if(!dead && targetanimation != hurtidleanim)
            if(behind || targetanimation == killanim || targetanimation == knifethrowanim ||
               targetanimation == knifefollowanim || targetanimation == spinkickreversalanim ||
               targetanimation == rabbitkickreversedanim || targetanimation == jumpreversedanim) {
        ...
        onterrain = 0;
        if(!isRun() && !animation[targetanimation].attack && targetanimation != getupfromfrontanim &&
           targetanimation != getupfrombackanim && targetanimation != sneakanim)
            targettilt2 = 0;
        if(targetanimation == jumpupanim || targetanimation == jumpdownanim || isFlip()) {
            flatvelocity = velocity;
            flatvelocity.y = 0;
            flatvelspeed = findLength(&flatvelocity);
            targettilt = flatvelspeed * fast_sqrt(abs(velocity.y) * .7) *
                         normaldotproduct(DoRotation(flatfacing, 0, -90, 0), flatvelocity);
        ...
        if(!animation[targetanimation].attack && targetanimation != getupfrombackanim &&
           targetanimation != getupfromfrontanim) {
            if(tilt2 > 25)
                tilt2 = 25;
            if(tilt2 < -25)
        ...
        if((targetanimation == fightidleanim || targetanimation == knifefightidleanim) &&
           (currentanimation == bounceidleanim || currentanimation == hurtidleanim)) {
            velocity += facing * multiplier * speed * 700 * scale;
            velspeed = findLength(&velocity);
        ...
        if((targetanimation == bounceidleanim || currentanimation == hurtidleanim) &&
           (currentanimation == fightidleanim || currentanimation == knifefightidleanim)) {
            velocity -= facing * multiplier * speed * 700 * scale;
            velspeed = findLength(&velocity);
            if(velspeed > speed * 2 * scale) {
                velocity /= velspeed;
        ...
        if(targetanimation != climbanim && targetanimation != hanganim && !isWallJump())
            coords += velocity * multiplier;

        if(coords.y < terrain.getHeight(coords.x, coords.z) &&
           (targetanimation == jumpdownanim || targetanimation == jumpupanim || isFlip())) {
            if(isFlip() && animation[targetanimation].label[targetframe] == 7)
                RagDoll(0);

            if(targetanimation == jumpupanim) {
                jumppower = -4;
                targetanimation = getIdle();
            }
            target = 0;
        ...
        if(targetanimation != jumpupanim && targetanimation != jumpdownanim && !isFlip() &&
           targetanimation != climbanim && targetanimation != hanganim && !isWallJump())
        ...
        if(isIdle() || targetanimation == drawrightanim || targetanimation == drawleftanim ||
           targetanimation == crouchdrawrightanim || targetanimation == crouchstabanim ||
           targetanimation == swordgroundstabanim || isStop() || targetanimation == removeknifeanim ||
           targetanimation == crouchremoveknifeanim || isLanding() || isCrouch() || animation[targetanimation].attack ||
           (targetanimation == rollanim && animation[targetanimation].label[targetframe] == 6)) {
            velspeed = findLength(&velocity);
            velocity.y = 0;
        ...
        if(skiddingdelay < 0)
            skiddingdelay += multiplier;
        if(skiddingdelay > .02 && !forwardkeydown && !backkeydown && !leftkeydown && !rightkeydown && !jumpkeydown &&
           isLanding() && !landhard) {
            skiddingdelay = -1;
            float gLoc[3];
            float vel[3];
        ...
        if(animation[targetanimation].attack == normalattack && targetanimation != rabbitkickanim &&
           !victim->skeleton.free) {
    ...
    if(findDistancefastflat(&coords, &midterrain) >
       (terrain.size * terrain.scale / 2 - viewdistance) * (terrain.size * terrain.scale / 2 - viewdistance)) {
        XYZ tempposit;
...
{
    int oldplayerdetail;
    if((frustum.SphereInFrustum(coords.x, coords.y + scale * 3, coords.z, scale * 8) &&
        findDistancefast(&viewer, &coords) < viewdistance * viewdistance) ||
       skeleton.free == 3) {
        ...
        playerdetail = 0;
        if(findDistancefast(&viewer, &coords) < viewdistance * viewdistance / 32 && config.video_detail == 2) {
            playerdetail = 1;
        }
        if(findDistancefast(&viewer, &coords) < viewdistance * viewdistance / 128 && config.video_detail == 1) {
            playerdetail = 1;
        }
        if(findDistancefast(&viewer, &coords) < viewdistance * viewdistance / 256 && (config.video_detail != 1 && config.video_detail != 2)) {
            playerdetail = 1;
        }
        if(id == 0)
            playerdetail = 1;
        ...
        if((dead != 2 || skeleton.free != 2) && updatedelay <= 0) {
            if(!isSleeping() && !isSitting()) {
                if(onterrain &&
                   ((isIdle() || isCrouch() || isLanding() || isLandhard() || targetanimation == drawrightanim ||
                     targetanimation == drawleftanim || targetanimation == crouchdrawrightanim) &&
                    (wasIdle() || wasCrouch() || wasLanding() || wasLandhard() || currentanimation == drawrightanim ||
                     currentanimation == drawleftanim || currentanimation == crouchdrawrightanim)) &&
                   !skeleton.free) {
                    ...
                    point.y = heightleft;
                    change = skeleton.joints[skeleton.jointlabels[leftankle]].position -
                             skeleton.joints[skeleton.jointlabels[leftfoot]].position;
                    change2 = skeleton.joints[skeleton.jointlabels[leftknee]].position -
                              skeleton.joints[skeleton.jointlabels[leftfoot]].position;
                    skeleton.joints[skeleton.jointlabels[leftfoot]].position =
                        DoRotation((point - coords) / scale, 0, -rotation, 0);
                    skeleton.joints[skeleton.jointlabels[leftankle]].position =
                        skeleton.joints[skeleton.jointlabels[leftfoot]].position + change;
                    skeleton.joints[skeleton.jointlabels[leftknee]].position =
                        (skeleton.joints[skeleton.jointlabels[leftfoot]].position + change2) / 2 +
                        (skeleton.joints[skeleton.jointlabels[leftknee]].position) / 2;
                    ...
                    point.y = heightright;
                    change = skeleton.joints[skeleton.jointlabels[rightankle]].position -
                             skeleton.joints[skeleton.jointlabels[rightfoot]].position;
                    change2 = skeleton.joints[skeleton.jointlabels[rightknee]].position -
                              skeleton.joints[skeleton.jointlabels[rightfoot]].position;
                    skeleton.joints[skeleton.jointlabels[rightfoot]].position =
                        DoRotation((point - coords) / scale, 0, -rotation, 0);
                    skeleton.joints[skeleton.jointlabels[rightankle]].position =
                        skeleton.joints[skeleton.jointlabels[rightfoot]].position + change;
                    skeleton.joints[skeleton.jointlabels[rightknee]].position =
                        (skeleton.joints[skeleton.jointlabels[rightfoot]].position + change2) / 2 +
                        (skeleton.joints[skeleton.jointlabels[rightknee]].position) / 2;
                    skeleton.DoConstraints(&coords, &scale);

                    if(creature == wolftype) {
                        point = DoRotation(skeleton.joints[skeleton.jointlabels[leftfoot]].position, 0, rotation, 0) *
                                    scale +
                                coords;
                        heightleft = terrain.getHeight(point.x, point.z) + .04;
                        point.y = heightleft;
                        ...
                        point = DoRotation(skeleton.joints[skeleton.jointlabels[rightfoot]].position, 0, rotation, 0) *
                                    scale +
                                coords;
                        heightright = terrain.getHeight(point.x, point.z) + .04;
                        point.y = heightright;
                ...
                if(onterrain &&
                   ...
                   !skeleton.free) {
                    ...
                    change2 = skeleton.joints[skeleton.jointlabels[leftknee]].position -
                              skeleton.joints[skeleton.jointlabels[leftfoot]].position;
                    skeleton.joints[skeleton.jointlabels[leftfoot]].position =
                        DoRotation((point - coords) / scale, 0, -rotation, 0) * target +
                        skeleton.joints[skeleton.jointlabels[leftfoot]].position * (1 - target);
                    skeleton.joints[skeleton.jointlabels[leftankle]].position =
                        skeleton.joints[skeleton.jointlabels[leftfoot]].position + change;
                    skeleton.joints[skeleton.jointlabels[leftknee]].position =
                        (skeleton.joints[skeleton.jointlabels[leftfoot]].position + change2) / 2 +
                    ...
                    skeleton.joints[skeleton.jointlabels[rightfoot]].position =
                        DoRotation((point - coords) / scale, 0, -rotation, 0) * target +
                        skeleton.joints[skeleton.jointlabels[rightfoot]].position * (1 - target);
                    skeleton.joints[skeleton.jointlabels[rightankle]].position =
                        skeleton.joints[skeleton.jointlabels[rightfoot]].position + change;
                    skeleton.joints[skeleton.jointlabels[rightknee]].position =
                        (skeleton.joints[skeleton.jointlabels[rightfoot]].position + change2) / 2 +
                ...
                if(onterrain &&
                   ...
                   !skeleton.free) {
                    ...
                    change2 = skeleton.joints[skeleton.jointlabels[leftknee]].position -
                              skeleton.joints[skeleton.jointlabels[leftfoot]].position;
                    skeleton.joints[skeleton.jointlabels[leftfoot]].position =
                        DoRotation((point - coords) / scale, 0, -rotation, 0) * (1 - target) +
                        skeleton.joints[skeleton.jointlabels[leftfoot]].position * target;
                    skeleton.joints[skeleton.jointlabels[leftankle]].position =
                        skeleton.joints[skeleton.jointlabels[leftfoot]].position + change;
                    skeleton.joints[skeleton.jointlabels[leftknee]].position =
                        (skeleton.joints[skeleton.jointlabels[leftfoot]].position + change2) / 2 +
                    ...
                    skeleton.joints[skeleton.jointlabels[rightfoot]].position =
                        DoRotation((point - coords) / scale, 0, -rotation, 0) * (1 - target) +
                        skeleton.joints[skeleton.jointlabels[rightfoot]].position * target;
                    skeleton.joints[skeleton.jointlabels[rightankle]].position =
                        skeleton.joints[skeleton.jointlabels[rightfoot]].position + change;
                    skeleton.joints[skeleton.jointlabels[rightknee]].position =
                        (skeleton.joints[skeleton.jointlabels[rightfoot]].position + change2) / 2 +
            ...
            if(!skeleton.free &&
               (!animation[targetanimation].attack && targetanimation != getupfrombackanim &&
                targetanimation != getupfrombackanim &&
                ((targetanimation != rollanim && !isFlip()) || animation[targetanimation].label[targetframe] == 6) &&
                targetanimation != getupfromfrontanim && targetanimation != wolfrunninganim &&
                targetanimation != rabbitrunninganim && targetanimation != backhandspringanim &&
                targetanimation != walljumpfrontanim && targetanimation != hurtidleanim && !isLandhard() &&
                !isSleeping()))
                DoHead();
            else {
                targetheadrotation = -targetrotation;
                targetheadrotation2 = 0;
                if(animation[targetanimation].attack == 3)
                    targetheadrotation += 180;
            }
            ...
            for(i = 0; i < skeleton.num_muscles; i++) {
                if((skeleton.muscles[i].numvertices > 0 && playerdetail) ||
                   (skeleton.muscles[i].numverticeslow > 0 && !playerdetail)) {
                    ...
                    start = 0;
                    endthing = 0;
                    if(skeleton.muscles[i].parent1->label == righthand ||
                       skeleton.muscles[i].parent2->label == righthand) {
                        morphness = righthandmorphness;
                        start = righthandmorphstart;
                        endthing = righthandmorphend;
                    }
                    if(skeleton.muscles[i].parent1->label == lefthand ||
                       skeleton.muscles[i].parent2->label == lefthand) {
                    ...
                    if((skeleton.muscles[i].parent1->label == neck && skeleton.muscles[i].parent2->label == abdomen) ||
                       (skeleton.muscles[i].parent2->label == neck && skeleton.muscles[i].parent1->label == abdomen)) {
                        morphness = chestmorphness;
                        start = chestmorphstart;
                        endthing = chestmorphend;
                    }
                    if((skeleton.muscles[i].parent1->label == groin && skeleton.muscles[i].parent2->label == abdomen) ||
                       (skeleton.muscles[i].parent2->label == groin && skeleton.muscles[i].parent1->label == abdomen)) {
                    ...
                    if(playerdetail || skeleton.free == 3) {
                        for(j = 0; j < skeleton.muscles[i].numvertices; j++) {
                            ...
                            glMatrixMode(GL_MODELVIEW); // Select The Modelview Matrix
                            glPushMatrix();
                            if(skeleton.muscles[i].parent1->label == abdomen ||
                               skeleton.muscles[i].parent2->label == abdomen)
                                glTranslatef(
                                    (skeleton.model[start].vertex[skeleton.muscles[i].vertices[j]].x * (1 - morphness) +
                                     skeleton.model[endthing].vertex[skeleton.muscles[i].vertices[j]].x * morphness) *
                                        proportionbody.x,
                                    (skeleton.model[start].vertex[skeleton.muscles[i].vertices[j]].y * (1 - morphness) +
                                     skeleton.model[endthing].vertex[skeleton.muscles[i].vertices[j]].y * morphness) *
                                        proportionbody.y,
                                    (skeleton.model[start].vertex[skeleton.muscles[i].vertices[j]].z * (1 - morphness) +
                                     skeleton.model[endthing].vertex[skeleton.muscles[i].vertices[j]].z * morphness) *
                                        proportionbody.z);
                            if(skeleton.muscles[i].parent1->label == lefthand ||
                               skeleton.muscles[i].parent1->label == righthand ||
                               skeleton.muscles[i].parent1->label == leftwrist ||
                               skeleton.muscles[i].parent1->label == rightwrist ||
                               skeleton.muscles[i].parent1->label == leftelbow ||
                               skeleton.muscles[i].parent1->label == rightelbow ||
                               skeleton.muscles[i].parent2->label == leftelbow ||
                               skeleton.muscles[i].parent2->label == rightelbow)
                                glTranslatef(
                                    (skeleton.model[start].vertex[skeleton.muscles[i].vertices[j]].x * (1 - morphness) +
                                     skeleton.model[endthing].vertex[skeleton.muscles[i].vertices[j]].x * morphness) *
                                        proportionarms.x,
                                    ...
                                    (skeleton.model[start].vertex[skeleton.muscles[i].vertices[j]].z * (1 - morphness) +
                                     skeleton.model[endthing].vertex[skeleton.muscles[i].vertices[j]].z * morphness) *
                                        proportionarms.z);
                            if(skeleton.muscles[i].parent1->label == leftfoot ||
                               skeleton.muscles[i].parent1->label == rightfoot ||
                               skeleton.muscles[i].parent1->label == leftankle ||
                               skeleton.muscles[i].parent1->label == rightankle ||
                               skeleton.muscles[i].parent1->label == leftknee ||
                               skeleton.muscles[i].parent1->label == rightknee ||
                               skeleton.muscles[i].parent2->label == leftknee ||
                               skeleton.muscles[i].parent2->label == rightknee)
                                glTranslatef(
                                    (skeleton.model[start].vertex[skeleton.muscles[i].vertices[j]].x * (1 - morphness) +
                                     skeleton.model[endthing].vertex[skeleton.muscles[i].vertices[j]].x * morphness) *
                                        proportionlegs.x,
                    ...
                    if(!playerdetail || skeleton.free == 3) {
                        for(j = 0; j < skeleton.muscles[i].numverticeslow; j++) {
                            ...
                            if(skeleton.muscles[i].parent1->label == abdomen ||
                               skeleton.muscles[i].parent2->label == abdomen)
                                glTranslatef(
                                    (skeleton.modellow.vertex[skeleton.muscles[i].verticeslow[j]].x) * proportionbody.x,
                                    (skeleton.modellow.vertex[skeleton.muscles[i].verticeslow[j]].y) * proportionbody.y,
                                    (skeleton.modellow.vertex[skeleton.muscles[i].verticeslow[j]].z) *
                                        proportionbody.z);
                            if(skeleton.muscles[i].parent1->label == lefthand ||
                               skeleton.muscles[i].parent1->label == righthand ||
                               skeleton.muscles[i].parent1->label == leftwrist ||
                               ...
                               skeleton.muscles[i].parent2->label == rightelbow)
                                glTranslatef(
                                    (skeleton.modellow.vertex[skeleton.muscles[i].verticeslow[j]].x) * proportionarms.x,
                            ...
                            if(skeleton.muscles[i].parent1->label == leftfoot ||
                               ...
                               skeleton.muscles[i].parent2->label == rightknee)
                                glTranslatef(
                                    (skeleton.modellow.vertex[skeleton.muscles[i].verticeslow[j]].x) * proportionlegs.x,
                                    (skeleton.modellow.vertex[skeleton.muscles[i].verticeslow[j]].y) * proportionlegs.y,
                                    (skeleton.modellow.vertex[skeleton.muscles[i].verticeslow[j]].z) *
                                        proportionlegs.z);
                            if(skeleton.muscles[i].parent1->label == head || skeleton.muscles[i].parent2->label == head)
                                glTranslatef(
                                    (skeleton.modellow.vertex[skeleton.muscles[i].verticeslow[j]].x) * proportionhead.x,
                ...
                if(skeleton.clothes && skeleton.muscles[i].numverticesclothes > 0) {
                    ...
                    for(j = 0; j < skeleton.muscles[i].numverticesclothes; j++) {
                        ...
                        if(skeleton.muscles[i].parent1->label == abdomen ||
                           skeleton.muscles[i].parent2->label == abdomen)
                            glTranslatef((skeleton.modelclothes.vertex[skeleton.muscles[i].verticesclothes[j]].x) *
                                             proportionbody.x,
                                         (skeleton.modelclothes.vertex[skeleton.muscles[i].verticesclothes[j]].y) *
                                             proportionbody.y,
                                         (skeleton.modelclothes.vertex[skeleton.muscles[i].verticesclothes[j]].z) *
                                             proportionbody.z);
                        if(skeleton.muscles[i].parent1->label == lefthand ||
                           skeleton.muscles[i].parent1->label == righthand ||
                           skeleton.muscles[i].parent1->label == leftwrist ||
            ...
            if(skeleton.free != 2 &&
               (skeleton.free == 1 || skeleton.free == 3 || id == 0 || (normalsupdatedelay <= 0) ||
                targetanimation == getupfromfrontanim || targetanimation == getupfrombackanim ||
                currentanimation == getupfromfrontanim || currentanimation == getupfrombackanim)) {
        ...
        if(showpoints) {
            ...
            if(playerdetail)
                for(i = 0; i < skeleton.drawmodel.vertexNum; i++) {
                    glVertex3f(
                        skeleton.drawmodel.vertex[i].x, skeleton.drawmodel.vertex[i].y, skeleton.drawmodel.vertex[i].z);
                }
            glEnd();
            glBegin(GL_LINES);
            ...
            if(playerdetail)
                for(i = 0; i < skeleton.drawmodel.TriangleNum; i++) {
                    glVertex3f(skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[0]].x,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[0]].y,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[0]].z);
                    glVertex3f(skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[1]].x,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[1]].y,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[1]].z);
                    glVertex3f(skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[1]].x,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[1]].y,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[1]].z);
                    glVertex3f(skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[2]].x,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[2]].y,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[2]].z);
                    glVertex3f(skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[2]].x,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[2]].y,
                               skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[2]].z);
                    glVertex3f(skeleton.drawmodel.vertex[skeleton.drawmodel.Triangles[i].vertex[0]].x,
        ...
        distance = (viewdistance * viewdistance -
                    (distance - (viewdistance * viewdistance * fadestart)) * (1 / (1 - fadestart))) /
        ...
        if(distance > 0) {
            ...
            // burnt=0;
            glColor4f((1 - (1 - terrainlight.x) / terrainheight) - burnt,
                      (1 - (1 - terrainlight.y) / terrainheight) - burnt,
                      (1 - (1 - terrainlight.z) / terrainheight) - burnt,
                      distance);
            glDisable(GL_BLEND);
            glAlphaFunc(GL_GREATER, 0.0001);
            ...
            if(tutoriallevel && id != 0) {
                ...
                if(canattack && cananger)
                    if(animation[targetanimation].attack == normalattack ||
                       animation[targetanimation].attack == reversed) {
                        glDisable(GL_TEXTURE_2D);
                        glColor4f(1, 0, 0, 0.8);
                    }
            ...
            if(playerdetail) {
                if(!showpoints) {
                    if((tutoriallevel && id != 0))
                        skeleton.drawmodel.drawdifftex(sprites.cloudimpacttexture);
                    else
            ...
            if(!playerdetail) {
                if((tutoriallevel && id != 0))
                    skeleton.drawmodellow.drawdifftex(sprites.cloudimpacttexture);
                else
            ...
            for(k = 0; k < numweapons; k++) {
                ...
                if(weaponactive == k) {
                    if(weapons.type[i] != staff) {
                        for(j = 0; j < skeleton.num_muscles; j++) {
                            if((skeleton.muscles[j].parent1->label == righthand ||
                                skeleton.muscles[j].parent2->label == righthand) &&
                               skeleton.muscles[j].numvertices > 0) {
                                weaponattachmuscle = j;
                            }
                        }
                        for(j = 0; j < skeleton.num_muscles; j++) {
                            if((skeleton.muscles[j].parent1->label == rightwrist ||
                                skeleton.muscles[j].parent2->label == rightwrist) &&
                               (skeleton.muscles[j].parent1->label != righthand &&
                                skeleton.muscles[j].parent2->label != righthand) &&
                               skeleton.muscles[j].numvertices > 0) {
                                weaponrotatemuscle = j;
                            }
                        }
                        weaponpoint = (skeleton.muscles[weaponattachmuscle].parent1->position +
                                       skeleton.muscles[weaponattachmuscle].parent2->position) /
                                      2;
                        if(creature == wolftype)
                            weaponpoint = (skeleton.joints[skeleton.jointlabels[rightwrist]].position * .7 +
                                           skeleton.joints[skeleton.jointlabels[righthand]].position * .3);
                    }
                    if(weapons.type[i] == staff) {
                        for(j = 0; j < skeleton.num_muscles; j++) {
                            if((skeleton.muscles[j].parent1->label == righthand ||
                        ...
                        for(j = 0; j < skeleton.num_muscles; j++) {
                            if((skeleton.muscles[j].parent1->label == rightelbow ||
                                skeleton.muscles[j].parent2->label == rightelbow) &&
                               (skeleton.muscles[j].parent1->label != rightshoulder &&
                        ...
                        vec1 = (skeleton.joints[skeleton.jointlabels[rightwrist]].position -
                                skeleton.joints[skeleton.jointlabels[rightelbow]].position);
                        vec2 = (skeleton.joints[skeleton.jointlabels[rightwrist]].position -
                                skeleton.joints[skeleton.jointlabels[rightshoulder]].position);
                        CrossProduct(&vec1, &vec2, &tempnormthing);
                        Normalise(&tempnormthing);
                        if(targetanimation != staffhitanim && currentanimation != staffhitanim &&
                           targetanimation != staffgroundsmashanim && currentanimation != staffgroundsmashanim &&
                           targetanimation != staffspinhitanim && currentanimation != staffspinhitanim)
                            weaponpoint += tempnormthing * .1 - skeleton.specialforward[1] * .3 +
                                           (skeleton.joints[skeleton.jointlabels[rightwrist]].position -
                                            skeleton.joints[skeleton.jointlabels[rightelbow]].position);
                        /*if(targetanimation==staffhitanim||currentanimation==staffhitanim){
                        XYZ weaptargnorm;
                ...
                if(weaponactive != k && weaponstuck != k) {
                    if(weapons.type[i] == knife)
                        weaponpoint = skeleton.joints[skeleton.jointlabels[abdomen]].position +
                                      (skeleton.joints[skeleton.jointlabels[righthip]].position -
                                       skeleton.joints[skeleton.jointlabels[lefthip]].position) *
                                          .1 +
                                      (skeleton.joints[skeleton.jointlabels[rightshoulder]].position -
                                       skeleton.joints[skeleton.jointlabels[leftshoulder]].position) *
                                          .35;
                        ...
                        weaponpoint = skeleton.joints[skeleton.jointlabels[abdomen]].position +
                                      ...
                                      (skeleton.joints[skeleton.jointlabels[leftshoulder]].position -
                                       skeleton.joints[skeleton.jointlabels[rightshoulder]].position) *
                                          .33;
                    for(j = 0; j < skeleton.num_muscles; j++) {
                        if((skeleton.muscles[j].parent1->label == abdomen ||
                            skeleton.muscles[j].parent2->label == abdomen) &&
                           (skeleton.muscles[j].parent1->label == neck || skeleton.muscles[j].parent2->label == neck) &&
                           skeleton.muscles[j].numvertices > 0) {
                            weaponrotatemuscle = j;
                        }
                    }
                ...
                if(weaponstuck == k) {
                    if(weaponstuckwhere == 0)
                        weaponpoint = skeleton.joints[skeleton.jointlabels[abdomen]].position * .5 +
                                      skeleton.joints[skeleton.jointlabels[neck]].position * .5 - skeleton.forward * .8;
                    else
                        weaponpoint = skeleton.joints[skeleton.jointlabels[abdomen]].position * .5 +
                                      skeleton.joints[skeleton.jointlabels[neck]].position * .5 + skeleton.forward * .8;
                    for(j = 0; j < skeleton.num_muscles; j++) {
                ...
                if(!skeleton.free) {
                    weapons.position[i] =
                        DoRotation(DoRotation(DoRotation(weaponpoint, 0, 0, tilt), tilt2, 0, 0), 0, rotation, 0) *
                            scale +
                        coords + currentoffset * (1 - target) * scale + targetoffset * target * scale;
                ...
                if(weaponactive == k) {
                    if(weapons.type[i] == knife) {
                        ...
                        if((currentanimation == crouchstabanim && targetanimation == crouchstabanim) ||
                           (currentanimation == backhandspringanim && targetanimation == backhandspringanim)) {
                            XYZ temppoint1, temppoint2, tempforward;
                            float distance;

                            temppoint1 = skeleton.joints[skeleton.jointlabels[righthand]].position;
                            temppoint2 = animation[currentanimation].weapontarget[currentframe] * (1 - target) +
                                         animation[targetanimation].weapontarget[targetframe] * (target);
                            ...
                            temppoint2.y = 0;
                            weapons.rotation1[i] =
                                acos((temppoint1.z - temppoint2.z) / findDistance(&temppoint1, &temppoint2));
                            weapons.rotation1[i] *= 360 / 6.28;
                            weapons.rotation3[i] = 0;
                            weapons.smallrotation[i] = -90;
                            weapons.smallrotation2[i] = 0;
                            if(temppoint1.x > temppoint2.x)
                                weapons.rotation1[i] = 360 - weapons.rotation1[i];
                        }
                        if((currentanimation == knifeslashreversalanim && targetanimation == knifeslashreversalanim) ||
                           (currentanimation == knifeslashreversedanim && targetanimation == knifeslashreversedanim)) {
                            XYZ temppoint1, temppoint2, tempforward;
                            float distance;
                    ...
                    if(weapons.type[i] == sword) {
                        ...
                        if((targetanimation == swordgroundstabanim && currentanimation == swordgroundstabanim) ||
                           (targetanimation == swordsneakattackanim && currentanimation == swordsneakattackanim) ||
                           (targetanimation == swordslashparryanim && currentanimation == swordslashparryanim) ||
                           (targetanimation == swordslashparriedanim && currentanimation == swordslashparriedanim) ||
                           (targetanimation == swordslashreversalanim && currentanimation == swordslashreversalanim) ||
                           (targetanimation == swordslashreversedanim && currentanimation == swordslashreversedanim) ||
                           (targetanimation == knifeslashreversalanim && currentanimation == knifeslashreversalanim) ||
                           (targetanimation == knifeslashreversedanim && currentanimation == knifeslashreversedanim) ||
                           (targetanimation == swordslashanim && currentanimation == swordslashanim) ||
                           (targetanimation == drawleftanim && currentanimation == drawleftanim) ||
                           (currentanimation == backhandspringanim && targetanimation == backhandspringanim)) {
                            XYZ temppoint1, temppoint2, tempforward;
                            float distance;

                            temppoint1 =
                                animation[currentanimation].position[skeleton.jointlabels[righthand]][currentframe] *
                                    (1 - target) +
                                animation[targetanimation].position[skeleton.jointlabels[righthand]][targetframe] *
                                    (target); // skeleton.joints[skeleton.jointlabels[righthand]].position;
                            temppoint2 = animation[currentanimation].weapontarget[currentframe] * (1 - target) +
                                         animation[targetanimation].weapontarget[targetframe] * (target);
                            distance = findDistance(&temppoint1, &temppoint2);
                            weapons.rotation2[i] = asin((temppoint1.y - temppoint2.y) / distance);
                    ...
                    if(weapons.type[i] == staff) {
                        ...
                        weapons.smallrotation2[i] = 0;
                        if((targetanimation == staffhitanim && currentanimation == staffhitanim) ||
                           (targetanimation == staffhitreversedanim && currentanimation == staffhitreversedanim) ||
                           (targetanimation == staffspinhitreversedanim &&
                            currentanimation == staffspinhitreversedanim) ||
                           (targetanimation == staffgroundsmashanim && currentanimation == staffgroundsmashanim) ||
                           (targetanimation == staffspinhitanim && currentanimation == staffspinhitanim)) {
    ...
    if(skeleton.free)
        calcrot = 1;
    if(animation[targetanimation].attack || isRun() || targetanimation == staggerbackhardanim || isFlip() ||
       targetanimation == climbanim || targetanimation == sneakanim || targetanimation == rollanim ||
       targetanimation == walkanim || targetanimation == backhandspringanim || isFlip() || isWallJump())
        calcrot = 1;
    if(currentanimation != targetanimation)
        calcrot = 1;
    // if(id==0)calcrot=1;
...
int Person::SphereCheck(XYZ* p1, float radius, XYZ* p, XYZ* move, float* rotate, Model* model)
{
    ...
    oldp1 = *p1;
    *p1 = *p1 - *move;
    if(findDistancefast(p1, &model->boundingspherecenter) >
       radius * radius + model->boundingsphereradius * model->boundingsphereradius)
        return -1;
    if(*rotate)
    ...
    for(i = 0; i < 4; i++) {
        for(j = 0; j < model->TriangleNum; j++) {
            if(model->facenormals[j].y <= slopethreshold) {
                intersecting = 0;
                distance = abs((model->facenormals[j].x * p1->x) + (model->facenormals[j].y * p1->y) +
                               (model->facenormals[j].z * p1->z) -
                               ((model->facenormals[j].x * model->vertex[model->Triangles[j].vertex[0]].x) +
                                (model->facenormals[j].y * model->vertex[model->Triangles[j].vertex[0]].y) +
                                (model->facenormals[j].z * model->vertex[model->Triangles[j].vertex[0]].z)));
                if(distance < radius) {
                    point = *p1 - model->facenormals[j] * distance;
                    if(PointInTriangle(&point,
                                       model->facenormals[j],
                                       &model->vertex[model->Triangles[j].vertex[0]],
                    ...
                    if(dotproduct(&model->facenormals[j], &end) > 0 && intersecting) {
                        ...
                        if(LineFacetd(&start,
                            ...
                            p1->y = point.y + radius;
                            if((targetanimation == jumpdownanim || isFlip())) {
                                if(isFlip() && (targetframe < 5 || animation[targetanimation].label[targetframe] == 7 ||
                                                animation[targetanimation].label[targetframe] == 4))
                                    RagDoll(0);
        ...
        for(j = 0; j < model->TriangleNum; j++) {
            if(model->facenormals[j].y > slopethreshold) {
                ...
                start = *p1;
                start.y -= radius / 4;
                distance = abs((model->facenormals[j].x * start.x) + (model->facenormals[j].y * start.y) +
                ...
                if(distance < radius * .5) {
                    ...
                    if(PointInTriangle(&point,
                        ...
                        intersecting = 1;
                    if(!intersecting)
                        intersecting = sphere_line_intersection(model->vertex[model->Triangles[j].vertex[0]].x,
                                                                model->vertex[model->Triangles[j].vertex[0]].y,
                                                                model->vertex[model->Triangles[j].vertex[0]].z,
                                                                model->vertex[model->Triangles[j].vertex[1]].x,
                                                                model->vertex[model->Triangles[j].vertex[1]].y,
                                                                model->vertex[model->Triangles[j].vertex[1]].z,
                                                                p1->x,
                                                                p1->y,
                                                                p1->z,
                                                                radius / 2);
                    if(!intersecting)
                        intersecting = sphere_line_intersection(model->vertex[model->Triangles[j].vertex[1]].x,
                                                                model->vertex[model->Triangles[j].vertex[1]].y,
                                                                model->vertex[model->Triangles[j].vertex[1]].z,
                                                                model->vertex[model->Triangles[j].vertex[2]].x,
                                                                model->vertex[model->Triangles[j].vertex[2]].y,
                                                                model->vertex[model->Triangles[j].vertex[2]].z,
                                                                p1->x,
                                                                p1->y,
                                                                p1->z,
                                                                radius / 2);
                    ...
                    if(dotproduct(&model->facenormals[j], &end) > 0 && intersecting) {
                        if((targetanimation == jumpdownanim || targetanimation == jumpupanim || isFlip())) {
                            start = velocity;
                            velocity -=
                                DoRotation(model->facenormals[j], 0, *rotate, 0) * findLength(&velocity) *
                                abs(normaldotproduct(
                                    velocity,
                                    DoRotation(
                                        model->facenormals[j], 0, *rotate, 0))); //(distance-radius*.5)/multiplier;
